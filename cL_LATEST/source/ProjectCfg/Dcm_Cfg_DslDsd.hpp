...
#define DCM_PARALLELPROCESSING_ENABLED                               DCM_CFG_OFF
...
#define DCM_CFG_WAIT_FOR_VIN                                DCM_CFG_MAX_WAITPEND
...
#define DCM_CFG_DEFAULT_P2STARMAX_TIME                                  5000000u
...
#define DCM_CFG_IN_PARAM_MAXLEN                                               0u
#define DCM_CFG_IN_PARAM_OBDMAXLEN                                             u
#define DCM_CFG_ATOMICREAD_DID                                                0u
#define DCM_CFG_ATOMICWRITE_DID                                               0u
#define DCM_CFG_MAX_PERIODIC_DID_READ                                         0u
#define DCM_CFG_MAX_DID_SCHEDULER                                             0u
#define DCM_UDS_DCMDSLPROTOCOLROW_UDS                                       0xF0

#ifndef DCM_TPMS_SERVICETABLE
#define DCM_TPMS_SERVICETABLE                                                0x0
#endif

#ifdef DcmConf_DcmDslProtocolRx_CGW_TPMS_Diag_Req_Can_Network_0_CANNODE_0_PduR2Dcm
...
#else
#define DcmConf_DcmDslProtocolRx_CGW_TPMS_Diag_Req_Can_Network_0_CANNODE_0_PduR2Dcm 0x0
#endif

#ifdef DcmConf_DcmDslProtocolRx_CGW_Diag_Func_Req_Can_Network_0_CANNODE_0_PduR2Dcm
#error "Symbolic names generated for DcmDslProtocolRxPduId is incorrect as the short names of configured DcmDslProtocolRx in not unique, Run Generate Id and Config Code generation once again."
#else
#define DcmConf_DcmDslProtocolRx_CGW_Diag_Func_Req_Can_Network_0_CANNODE_0_PduR2Dcm 0x1
#endif

#ifdef DcmConf_DcmDslProtocolTx_TPMS_Diag_Resp_Can_Network_0_CANNODE_0_Phys_Dcm2PduR
...
#else
#define DcmConf_DcmDslProtocolTx_TPMS_Diag_Resp_Can_Network_0_CANNODE_0_Phys_Dcm2PduR 0x0
#endif
...
extern uint8 Dcm_DspArrayByteSignal_au8 [];
extern sint8 Dcm_DspArraySignal_as8 [];
extern sint8 Dcm_DspArrayByteSignal_as8 [];
...
extern uint16 Dcm_DspArrayByteSignal_au16[];
extern sint16 Dcm_DspArraySignal_as16[];
extern sint16 Dcm_DspArrayByteSignal_as16[];
...
extern uint32 Dcm_DspArrayByteSignal_au32[];
extern sint32 Dcm_DspArraySignal_as32[];
extern sint32 Dcm_DspArrayByteSignal_as32[];
