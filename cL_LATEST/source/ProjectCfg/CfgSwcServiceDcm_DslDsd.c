...
#include "Dcm_Cfg_MemMap.hpp"
static CONST(Type_SwcServiceCom_tIdPdu, DCM_CONST) Dcm_DsldTxTable_cast[DCM_NUM_TX_PDUID] = {PduRConf_PduRSrcPdu_TPMS_Diag_Resp_Can_Network_0_CANNODE_0_Phys_Dcm2PduR};
