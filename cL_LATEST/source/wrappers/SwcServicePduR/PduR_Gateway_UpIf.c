...
Std_ReturnType PduR_GF_Com_Transmit_Func( Type_SwcServiceCom_tIdPdu id, const Type_SwcServiceCom_stInfoPdu * info)
{
...
Std_ReturnType PduR_GF_IpduM_Transmit_Func(Type_SwcServiceCom_tIdPdu id, const Type_SwcServiceCom_stInfoPdu * info)
{
...
Std_ReturnType PduR_GF_SecOC_Transmit_Func( Type_SwcServiceCom_tIdPdu id, const Type_SwcServiceCom_stInfoPdu * info)
{
