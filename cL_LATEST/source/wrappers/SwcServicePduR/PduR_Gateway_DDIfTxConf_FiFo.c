...
void PduR_GF_DDIf_FIFO_TxConfirmation_Func( Type_SwcServiceCom_tIdPdu gwayId )
#else

void PduR_GF_DDIf_FIFO_TxConfirmation_Func( Type_SwcServiceCom_tIdPdu gwayId,Std_ReturnType result )
#endif
{
