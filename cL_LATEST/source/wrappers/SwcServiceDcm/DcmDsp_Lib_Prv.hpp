...
LOCAL_INLINE uint8 Dcm_Lok_GetDemClientId(boolean Context)
{
   uint8 DemClientID_u8;
    ...
    DemClientID_u8 = (Context == DCM_UDSCONTEXT)?
                      CfgSwcServiceDcm_stDsld.protocol_table_pcs[Dcm_DsldGlobal_st.idxCurrentProtocol_u8].demclientid:
                      CfgSwcServiceDcm_stDsld.protocol_table_pcs[Dcm_OBDGlobal_st.idxCurrentProtocol_u8].demclientid;
#else
    DemClientID_u8 = CfgSwcServiceDcm_stDsld.protocol_table_pcs[Dcm_DsldGlobal_st.idxCurrentProtocol_u8].demclientid;
    (void) Context;
#endif
