...
static void Dcm_Lok_ProcessResult(
...
LOCAL_INLINE Std_ReturnType Dcm_Lok_DsdSupplierNotification(Dcm_MsgContextType MsgContext_st
   ...
   Type_SwcServiceCom_tLengthPdu RequestLength = MsgContext_st.reqDataLen;
   Type_SwcServiceCom_tIdPdu DcmRxPduId = MsgContext_st.dcmRxPduId;
...
LOCAL_INLINE void Dcm_Lok_UpdateOpStatus(
