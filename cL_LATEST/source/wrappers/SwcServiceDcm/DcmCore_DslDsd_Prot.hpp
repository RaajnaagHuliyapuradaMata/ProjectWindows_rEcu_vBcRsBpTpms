...
#endif
#if(DCM_PARALLELPROCESSING_ENABLED != DCM_CFG_OFF)
extern boolean Dcm_Lok_IsTxPduIdOBD(Type_SwcServiceCom_tIdPdu DcmTxPduId);
extern boolean Dcm_Lok_IsRxPduIdOBD(Type_SwcServiceCom_tIdPdu DcmRxPduId);
#endif
#define DCM_STOP_SEC_CODE
#include "Dcm_Cfg_MemMap.hpp"
...
typedef struct{
   ...
   Type_SwcServiceCom_tIdPdu dataNewRxPduId_u8;
#if((DCM_ROE_ENABLED != DCM_CFG_OFF)||(DCM_CFG_RDPI_ENABLED != DCM_CFG_OFF))
   Type_SwcServiceCom_tIdPdu dataPassRxPduId_u8;
#endif
#endif
...
#endif
#if(DCM_CFG_PROTOCOL_PREMPTION_ENABLED != DCM_CFG_OFF)
   Type_SwcServiceCom_tLengthPdu dataNewdataRequestLength_u16;
#endif
#if((DCM_ROE_ENABLED != DCM_CFG_OFF)||(DCM_CFG_RDPI_ENABLED != DCM_CFG_OFF))
#if(DCM_CFG_PROTOCOL_PREMPTION_ENABLED != DCM_CFG_OFF)
   Type_SwcServiceCom_tLengthPdu dataPassdataRequestLength_u16;
#endif
...
typedef struct{
    ...
    Dcm_MsgType  adrBufferPtr_pu8;
   Type_SwcServiceCom_tLengthPdu dataQueueReqLength_u16;
   Type_SwcServiceCom_tIdPdu dataQueueRxPduId_u8;
...
typedef struct{
   ...
   Type_SwcServiceCom_tIdPdu   RxPduId_u8;
...
#if(DCM_PARALLELPROCESSING_ENABLED != DCM_CFG_OFF)
extern Type_SwcServiceCom_stInfoPdu Dcm_OBDPduInfo_st;
...
extern     VAR(Type_SwcServiceCom_stInfoPdu,                   DCM_VAR                  ) Dcm_DsldRdpi2pduinfo_ast[DCM_CFG_NUM_RDPITYPE2_TXPDU];
...
extern void Dcm_Lok_SendResponse(const Type_SwcServiceCom_stInfoPdu * adrPduStrucutre_pcst);
#if(DCM_PARALLELPROCESSING_ENABLED != DCM_CFG_OFF)
extern FUNC(void, DCM_CODE) Dcm_Lok_OBDSendResponse(P2CONST(Type_SwcServiceCom_stInfoPdu, AUTOMATIC, DCM_INTERN_DATA) adrPduStrucutre_pcst);
#endif
...
#if(DCM_PARALLELPROCESSING_ENABLED != DCM_CFG_OFF)
extern void Dcm_Lok_ResetOBDCopyRxDataStatus(Type_SwcServiceCom_tIdPdu id);
#endif
...
extern BufReq_ReturnType Dcm_DsldPersistentRoeHandling_en(
   ...
   ,                                        Type_SwcServiceCom_tLengthPdu nrTpSduLength_u16
