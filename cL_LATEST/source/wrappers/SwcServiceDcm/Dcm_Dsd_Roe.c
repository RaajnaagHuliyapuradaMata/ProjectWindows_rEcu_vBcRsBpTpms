...
Type_SwcServiceCom_stInfoPdu Dcm_DsldRoe2PduInfo_st;
#define DCM_STOP_SEC_VAR_CLEARED_UNSPECIFIED
#include "Dcm_Cfg_MemMap.hpp"
#define DCM_START_SEC_VAR_CLEARED_8
#include "Dcm_Cfg_MemMap.hpp"
...
static Dcm_StatusType Dcm_UpdateROEQueue( uint8 RoeEventId, Type_SwcServiceCom_tIdPdu RxPdu)
{
   uint8 index_u8;
...
static Dcm_StatusType Dcm_GetRoeProtValidity(Type_SwcServiceCom_tIdPdu DcmRxPduId
...
static Dcm_StatusType Dcm_Lok_ROE_TYPE1( Dcm_MsgType adrSrc_pu8,
   ...
   ,       Type_SwcServiceCom_tIdPdu dcmRxPduId_u8)
{
   ...
   if(roeReqAccepted_b)
   {
        ...
        Dcm_DsldGlobal_st.dataRequestLength_u16 = (Type_SwcServiceCom_tLengthPdu) MsgLen;
   	...
   	DsdState_en = Dcm_Lok_GetDsdState();
        ...
        if( Dcm_DcmDspEventQueue[DcmRoeQueueIndex_u8].EventId_u8 == DCM_ROE_DTCEVENTID)
        {
            ...
            *adrSrc_pu8 = 0x0Eu;
            ...
            Dcm_DsldGlobal_st.dataRequestLength_u16 =(Type_SwcServiceCom_tLengthPdu)2u;
        }
        else
#endif
        {
           ...
           Dcm_DsldGlobal_st.dataRequestLength_u16 =(Type_SwcServiceCom_tLengthPdu)3u;
#endif
        }
        Dcm_DsldGlobal_st.dataOldSrvtable_u8 = Dcm_DsldGlobal_st.datActiveSrvtable_u8;
        Dcm_DsldGlobal_st.datActiveSrvtable_u8 = Dcm_DsldRoe_pcst->servicetable_Id_u8;
