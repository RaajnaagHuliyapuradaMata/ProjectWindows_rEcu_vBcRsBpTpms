...
#include "Dcm_Cfg_MemMap.hpp"
static Type_SwcServiceCom_stInfoPdu Dcm_adrDataPtr_pst;
static Type_SwcServiceCom_stInfoPdu * Dcm_PduInfo_pst;
#if(DCM_PARALLELPROCESSING_ENABLED != DCM_CFG_OFF)
static Type_SwcServiceCom_stInfoPdu Dcm_ObdadrDataPtr_pst;
static Type_SwcServiceCom_stInfoPdu* Dcm_ObdPduInfo_pst;
#endif
#define DCM_STOP_SEC_VAR_CLEARED_UNSPECIFIED
#include "Dcm_Cfg_MemMap.hpp"

LOCAL_INLINE boolean Dcm_Lok_isRetryRequested(const RetryInfoType * RetryInfoPtr
   ,       const Type_SwcServiceCom_stInfoPdu * PduInfoPtr,BufReq_ReturnType * RetValPtr)
{
...
LOCAL_INLINE boolean Dcm_Lok_isNormalResponseAvailable(Type_SwcServiceCom_tIdPdu DcmTxPduId)
{
...
LOCAL_INLINE boolean Dcm_Lok_isPagedBufferResponseAvailable(Type_SwcServiceCom_tIdPdu DcmTxPduId)
{
   return((CfgSwcServiceDcm_stDsld.ptr_txtable_pca[DcmTxPduId] == Dcm_DsldGlobal_st.dataActiveTxPduId_u8) && \
...
LOCAL_INLINE boolean Dcm_Lok_isRoeType2ResponseAvailable(Type_SwcServiceCom_tIdPdu DcmTxPduId)
{
...
LOCAL_INLINE boolean Dcm_Lok_isCurrentPageTransmitted(Type_SwcServiceCom_tLengthPdu SduLength
   ...
   ,       const RetryInfoType * RetryInfoPtr)
{
   ...
   switch(subStateTemp_u8)
   {
        case DSL_SUBSTATE_DATA_READY :
            ...
            if(PduInfoPtr->SduLength <= (Type_SwcServiceCom_tLengthPdu)Dcm_DsldGlobal_st.dataCurrentPageRespLength_u32)
            {
                Dcm_DsldPduInfo_st.SduDataPtr = &Dcm_DsldGlobal_st.adrActiveTxBuffer_tpu8[0];
                Dcm_DsldPduInfo_st.SduLength  = (Type_SwcServiceCom_tLengthPdu)Dcm_DsldGlobal_st.dataCurrentPageRespLength_u32;
...
static boolean Dcm_Lok_isNrc21ResponseAvailable(uint16 * ServiceIdPtr
   ,       Type_SwcServiceCom_tIdPdu DcmTxPduId)
{
   boolean isNrc21Available_b  = FALSE;
   uint8 connectionId_u8     = 0u;
   uint8 idxProtocol_u8      = 0u;
   Type_SwcServiceCom_tIdPdu idxTxpduid_u8   = 0u;
   Type_SwcServiceCom_tIdPdu idxPduId_u16   = 0u;
...
#if(DCM_PARALLELPROCESSING_ENABLED != DCM_CFG_OFF)
static boolean Dcm_Lok_OBDisNrc21ResponseAvailable(uint8* ServiceIdPtr,Type_SwcServiceCom_tIdPdu DcmTxPduId)
{
   boolean isNrc21Available_b = FALSE;
   uint8 connectionId_u8 = 0u;
   uint8 idxProtocol_u8 = 0u;
...
static BufReq_ReturnType Dcm_Lok_ValidateCopyTxDataType (Type_SwcServiceCom_tIdPdu DcmTxPduId
   ,       const Type_SwcServiceCom_stInfoPdu * PduInfoPtr
   ,       const RetryInfoType * RetryInfoPtr)
{
    BufReq_ReturnType bufRequestStatus_en = BUFREQ_E_NOT_OK;
...
#if(DCM_PARALLELPROCESSING_ENABLED != DCM_CFG_OFF)
static BufReq_ReturnType Dcm_Lok_OBDValidateCopyTxDataType(Type_SwcServiceCom_tIdPdu DcmTxPduId)
{
    BufReq_ReturnType bufRequestStatus_en = BUFREQ_E_NOT_OK;
...
static boolean Dcm_CopyTxData_CheckEnvironment (Type_SwcServiceCom_tIdPdu DcmTxPduId
   ,       const Type_SwcServiceCom_stInfoPdu * PduInfoPtr)
{
...
BufReq_ReturnType Dcm_CopyTxData(Type_SwcServiceCom_tIdPdu id,

const Type_SwcServiceCom_stInfoPdu * info,RetryInfoType * retry,
Type_SwcServiceCom_tLengthPdu * availableDataPtr )
{
    BufReq_ReturnType bufRequestStatus_en = BUFREQ_E_NOT_OK;
   Type_SwcServiceCom_stInfoPdu* TempPduInfo_pst;
