...
LOCAL_INLINE boolean Dcm_Lok_isConfirmationReceivedForNrc21Response(Type_SwcServiceCom_tIdPdu DcmTxPduId
   ,
   uint8 idxRxPduId){
   ...
   Type_SwcServiceCom_tIdPdu idxTxpduid_u8   = Dcm_DsldConnTable_pcst[ConnectionId_u8].txpduid_num_u8;
...
void Dcm_Lok_SendResponse(
   const Type_SwcServiceCom_stInfoPdu* adrPduStrucutre_pcst){
