...
LOCAL_INLINE boolean Dcm_Lok_isFunctionalTesterPresentReceived(Type_SwcServiceCom_tIdPdu DcmRxPduId)
{
    return ((Dcm_DslRxPduArray_ast[DcmRxPduId].Dcm_DslFuncTesterPresent_b) && \
            !(Dcm_DslRxPduArray_ast[DcmRxPduId].Dcm_DslCopyRxData_b));
}

LOCAL_INLINE boolean Dcm_Lok_isValidRequestReceived(Type_SwcServiceCom_tIdPdu DcmRxPduId)
{
    return(Dcm_DslRxPduArray_ast[DcmRxPduId].Dcm_DslCopyRxData_b);
}

LOCAL_INLINE boolean Dcm_Lok_isLowPriorityRequestReceived(Type_SwcServiceCom_tIdPdu DcmRxPduId)
{
...
static void Dcm_Lok_CopyDataToRxBuffer(Type_SwcServiceCom_tIdPdu DcmRxPduId
...
static void Dcm_Lok_ProvideRxBufferSize(Type_SwcServiceCom_tIdPdu DcmRxPduId
   ,       Type_SwcServiceCom_tLengthPdu * RxBufferSizePtr)
{
...
static BufReq_ReturnType Dcm_Lok_ProcessCopyRxData(Type_SwcServiceCom_tIdPdu DcmRxPduId
   ,       const Type_SwcServiceCom_stInfoPdu * PduInfoPtr
   ,       Type_SwcServiceCom_tLengthPdu * RxBufferSizePtr)
{
...
static boolean Dcm_Lok_CopyRxData_CheckEnvironment(Type_SwcServiceCom_tIdPdu DcmRxPduId
   ,       const Type_SwcServiceCom_stInfoPdu * PduInfoPtr
...
static void Dcm_Lok_ProvideOBDRxBufferSize(Type_SwcServiceCom_tIdPdu DcmRxPduId,Type_SwcServiceCom_tLengthPdu* RxBufferSizePtr)
{
...
static void Dcm_Lok_CopyOBDDataToRxBuffer(Type_SwcServiceCom_tIdPdu DcmRxPduId, const Type_SwcServiceCom_stInfoPdu* PduInfoPtr
   ,                                                     Type_SwcServiceCom_tLengthPdu* RxBufferSizePtr)
{
...
static BufReq_ReturnType Dcm_Lok_CheckOBDRxData(Type_SwcServiceCom_tIdPdu DcmRxPduId, const Type_SwcServiceCom_stInfoPdu* PduInfoPtr
   ,                                                     Type_SwcServiceCom_tLengthPdu* RxBufferSizePtr)
{
    BufReq_ReturnType bufRequestStatus_en = BUFREQ_E_NOT_OK;
...
static BufReq_ReturnType Dcm_Lok_OBDCopyRxData(Type_SwcServiceCom_tIdPdu DcmRxPduId
   ,      const Type_SwcServiceCom_stInfoPdu* PduInfoPtr, Type_SwcServiceCom_tLengthPdu* RxBufferSizePtr)
{
...
BufReq_ReturnType Dcm_CopyRxData( Type_SwcServiceCom_tIdPdu id
   ,  const Type_SwcServiceCom_stInfoPdu * PduInfoPtr
