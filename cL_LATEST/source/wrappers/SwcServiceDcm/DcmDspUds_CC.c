...
static NetworkHandleType Dcm_nrSubNet_u8;
...
static Dcm_CommunicationModeType Dcm_Lok_GetCommModeType_u8(uint8 ControlType_u8
   ,       uint8 dataCommType_u8 )
{

   uint8 adrComModeIndex_au8[4]={0,0,4,8};

    Dcm_CommunicationModeType CommModeType[12] =
   {
...
static uint8 Dcm_Lok_DspChkSubnetID_u8(NetworkHandleType dataSubnetID_u8
...
static Std_ReturnType Dcm_Lok_CC_Check(const Dcm_MsgContextType * pMsgContext
   ,       Dcm_NegativeResponseCodeType * dataNegRespCode_u8)
{
   uint8 dataCommType_u8;
...
Std_ReturnType SwcServiceDcm_tCommunicationControl (Dcm_SrvOpStatusType OpStatus
...
static void Dcm_Lok_DspCommunicationControlSwitchMode(void){
   uint8 idxIndex_u8;
...
void Dcm_Lok_DspCommCntrlConfirmation(
...
static boolean Dcm_Lok_CCMmodeStatusCheck(void){
...
static void Dcm_Lok_ResetCommunicationMode(void){
   uint8 idxLoop_u8;
   boolean stStatus_b;
...
void Dcm_Lok_CC_Mainfunction (void){
