...
extern Std_ReturnType DcmAppl_DcmNotification (
   ...
   ,                                                    Type_SwcServiceCom_tLengthPdu RequestLength
   ,                                                    uint8 RequestType
...
extern void DcmAppl_CopyRxData(Type_SwcServiceCom_tIdPdu DcmRxPduId
   ,                                                     Type_SwcServiceCom_tLengthPdu RxBufferSize
                                                      );

extern void DcmAppl_TpRxIndication( Type_SwcServiceCom_tIdPdu DcmRxPduId
