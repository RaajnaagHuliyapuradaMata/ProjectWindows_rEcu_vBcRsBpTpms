...
LOCAL_INLINE boolean Com_CheckRxIPduControlViaRbaNdsEcuVariant(Type_SwcServiceCom_tIdPdu IpduId);
#endif

#ifdef COM_TXIPDUCONTROL_VIA_RBA_NDS_ECUVARIANT
LOCAL_INLINE boolean Com_CheckTxIPduControlViaRbaNdsEcuVariant(Type_SwcServiceCom_tIdPdu IpduId);
#endif
...
LOCAL_INLINE void Com_Lok_TxIpduInitializeCounter(Type_SwcServiceCom_tIdPdu ComTxPduId);
#endif
