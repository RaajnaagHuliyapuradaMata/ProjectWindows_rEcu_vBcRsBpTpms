...
LOCAL_INLINE boolean Com_Lok_LoadPeriodicModeInfo(Type_SwcServiceCom_tIdPdu ComTxPduId, Com_SendIpduInfo sendIpduFlag_u16);

LOCAL_INLINE boolean Com_Lok_LoadEventModeInfo(Type_SwcServiceCom_tIdPdu ComTxPduId, Com_SendIpduInfo sendIpduFlag_u16);

LOCAL_INLINE Type_SwcServiceCom_tLengthPdu Com_Lok_CalculateTxPduLength(Type_SwcServiceCom_tIdPdu ComTxPduId);

LOCAL_INLINE void Com_Lok_ProcessTxReqStatus(Type_SwcServiceCom_tIdPdu ComTxPduId, Std_ReturnType ipduTransStatus_ui);
...
LOCAL_INLINE void Com_Lok_TxIpduIncrementCounter(Type_SwcServiceCom_tIdPdu ComTxPduId);
LOCAL_INLINE void Com_Lok_TxIpduDecrementCounter(Type_SwcServiceCom_tIdPdu ComTxPduId);
...
void Com_Lok_SendIpdu(Type_SwcServiceCom_tIdPdu ComTxPduId, Com_SendIpduInfo sendIpduFlag_u16)
{
   ...
   {
        Type_SwcServiceCom_stInfoPdu         ComTxIPduInfo;
...
LOCAL_INLINE Type_SwcServiceCom_tLengthPdu Com_Lok_CalculateTxPduLength(Type_SwcServiceCom_tIdPdu ComTxPduId)
{
   ...
   Com_TxIpduRamPtrType        TxIpduRamPtr;
#endif
   Type_SwcServiceCom_tLengthPdu               comTxPduLength;
