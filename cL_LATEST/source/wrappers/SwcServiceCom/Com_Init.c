...
LOCAL_INLINE void Com_Lok_Init_RxSignal(Type_SwcServiceCom_tIdPdu IpduId);

#ifdef COM_RX_SIGNALGROUP
LOCAL_INLINE void Com_Lok_Init_RxSignalGroup(Type_SwcServiceCom_tIdPdu IpduId);
#endif

LOCAL_INLINE void Com_Lok_Init_Send(void);

LOCAL_INLINE void Com_Lok_Init_TxSignal(Type_SwcServiceCom_tIdPdu IpduId);

#ifdef COM_TX_SIGNALGROUP
LOCAL_INLINE void Com_Lok_Init_TxSignalGroup(Type_SwcServiceCom_tIdPdu IpduId);
...
LOCAL_INLINE void Com_Lok_Init_RxIpduWoGroupRef(Type_SwcServiceCom_tIdPdu IpduId);
LOCAL_INLINE void Com_Lok_Init_TxIpduWoGroupRef(Type_SwcServiceCom_tIdPdu IpduId);
#endif
...
LOCAL_INLINE void Com_Lok_Init_Receive(void){
   ...
   for(idx_IpduId_u16 = COM_ZERO; idx_IpduId_u16 < COM_GET_NUM_RX_IPDU; idx_IpduId_u16++)
   {
        ...
        if(Com_GetValue(RXIPDU,_PDUWITHPDUGRP,RxIpduConstPtr->rxIPduFields ) == COM_FALSE)
        {
            ...
            Com_Lok_Init_RxIpduWoGroupRef((Type_SwcServiceCom_tIdPdu)idx_IpduId_u16);
        }
        else
#endif
        {
...
# endif
        ...
        Com_Lok_Init_RxSignal((Type_SwcServiceCom_tIdPdu)idx_IpduId_u16);

#ifdef COM_RX_SIGNALGROUP

        Com_Lok_Init_RxSignalGroup((Type_SwcServiceCom_tIdPdu)idx_IpduId_u16);
#endif
...
LOCAL_INLINE void Com_Lok_Init_Send(void){
   ...
   for(idx_IpduId_u16 = COM_ZERO; idx_IpduId_u16 < COM_GET_NUM_TX_IPDU; idx_IpduId_u16++)
   {
        ...
        if(Com_GetValue(TXIPDU,_PDUWITHPDUGRP,TxIpduConstPtr->txIPduFields) == COM_FALSE)
        {
            ...
            Com_Lok_Init_TxIpduWoGroupRef((Type_SwcServiceCom_tIdPdu)idx_IpduId_u16);
        }
        else
#endif
        {
        ...
        Com_Lok_Init_TxSignal((Type_SwcServiceCom_tIdPdu)idx_IpduId_u16);

#ifdef COM_TX_SIGNALGROUP

        Com_Lok_Init_TxSignalGroup((Type_SwcServiceCom_tIdPdu)idx_IpduId_u16);
#endif
        ...
        if(TxIpduConstPtr->TxIpduCntr_Index != COM_TXIPDU_CNTR_INV_IDX)
        {
            ...
            Com_Lok_TxIpduInitializeCounter( (Type_SwcServiceCom_tIdPdu)idx_IpduId_u16 );
        }
        else{
