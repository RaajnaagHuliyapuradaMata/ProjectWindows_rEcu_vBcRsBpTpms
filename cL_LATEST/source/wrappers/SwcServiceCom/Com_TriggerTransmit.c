...
Std_ReturnType Com_TriggerTransmit(Type_SwcServiceCom_tIdPdu TxPduId, Type_SwcServiceCom_stInfoPdu * PduInfoPtr)
{
...
#endif
   {
      ...
      defined(COM_TX_DYNAMIC_SIGNAL_SUPPORT) || defined(COM_TxIPduCallOuts))
        ...
        {
            Size += (Type_SwcServiceCom_tLengthPdu)(TxIpduRamPtr->Com_DynLength);
        }
#endif
