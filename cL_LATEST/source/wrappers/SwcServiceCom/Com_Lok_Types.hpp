...
typedef struct{
   Type_SwcServiceCom_tLengthPdu                                   FirstByteNo;
...
typedef struct{
   ...
   Type_SwcServiceCom_tLengthPdu                                   lastByte_u8;
...
typedef struct{
   ...
   boolean (*CallOut) (Type_SwcServiceCom_tIdPdu id, Type_SwcServiceCom_stInfoPdu * ptr);
#endif
#ifdef COM_TxIPduNotification
...
typedef struct{
   void (*CntrErrNotif_Cbk) (Type_SwcServiceCom_tIdPdu Id, uint8 ExpCntr, uint8 RxCntr);
   Com_BitpositionType                             CntrBitPos;
   uint8                                           CntrBitSize;
   uint8                                           CntrThreshold;
...
typedef struct{
   ...
   boolean (*CallOut) (Type_SwcServiceCom_tIdPdu id, const Type_SwcServiceCom_stInfoPdu * ptr);
#endif
...
typedef struct{
   ...
   Type_SwcServiceCom_tLengthPdu                                   TxTPIPduLength;
#endif
...
#ifdef COM_TP_IPDUTYPE
   Type_SwcServiceCom_tLengthPdu                                   RxTPIPduLength;
#endif
#ifdef COM_RxIPduTimeout
   uint16                                          RxTicks_u16;
...
typedef struct{
   Type_SwcServiceCom_tIdPdu *                                     RxGwQueuePtr;
...
typedef struct{
   ...
   const Type_SwcServiceCom_tIdPdu *                               Com_TxIpduMapping_pcst;

   const Com_Lok_xRxIpduInfoCfg_tst *              Com_RxIpdu_pcst;

   const Type_SwcServiceCom_tIdPdu *                               Com_RxIpduMapping_pcst;
   ...
   Type_SwcServiceCom_tLengthPdu *                                 Com_TpTxIpduLength_pauo;
#endif
...
# endif
   ...
   Type_SwcServiceCom_tIdPdu *                                     Com_RxGwQueue_paux;
