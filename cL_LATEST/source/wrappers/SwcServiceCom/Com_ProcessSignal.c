...
#endif
            {
                Type_SwcServiceCom_tLengthPdu       SigLastByteNo;
                ...
                if(SigEndianess != COM_BIGENDIAN)
                {
                    ...
                    SigLastByteNo   = (Type_SwcServiceCom_tLengthPdu)((lastBitPosition != COM_ZERO) ? ((lastBitPosition - COM_ONE) >> 3u) : (COM_ZERO));
                }
                else{
                                                ...
                                                )
{
   ...
   {
        Type_SwcServiceCom_tLengthPdu       UB_ByteNo_u8;
