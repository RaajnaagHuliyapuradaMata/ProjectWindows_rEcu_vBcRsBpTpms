...
LOCAL_INLINE boolean Com_ProcessRxIPduCounter(Type_SwcServiceCom_tIdPdu RxPduId, const Type_SwcServiceCom_stInfoPdu * PduInfoPtr);
#endif

#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
void Com_RxIndication(Type_SwcServiceCom_tIdPdu RxPduId, const Type_SwcServiceCom_stInfoPdu * PduInfoPtr)
{
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
boolean Com_IsValidRxIpdu(Type_SwcServiceCom_tIdPdu PduId, const Type_SwcServiceCom_stInfoPdu * PduInfoPtr)
{
   Com_RxIpduConstPtrType  RxIpduConstPtr;
...
LOCAL_INLINE boolean Com_ProcessRxIPduCounter(Type_SwcServiceCom_tIdPdu RxPduId, const Type_SwcServiceCom_stInfoPdu * PduInfoPtr)
{
   ...
   Type_SwcServiceCom_tLengthPdu                   counterByteNo_uo;
   ...
   counterByteNo_uo   = (Type_SwcServiceCom_tLengthPdu)(RxIpduCntrConstPtr->CntrBitPos / 8u);
...
void Com_InvokeRxNotifications(Type_SwcServiceCom_tIdPdu RxPduId)
{
   Com_RxIpduConstPtrType          RxIpduConstPtr;
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
uint8 Com_ReadRxIPduLength(Type_SwcServiceCom_tIdPdu RxPduId, Type_SwcServiceCom_tLengthPdu * RxIPduLengthPtr)
{
   uint8       Status;
