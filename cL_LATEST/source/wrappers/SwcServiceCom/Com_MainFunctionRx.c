...
LOCAL_INLINE void Com_Lok_RxTimeoutProcessing(Type_SwcServiceCom_tIdPdu RxPduId, boolean RxIndication_b);
#endif

#ifdef COM_RxIPduTimeout

LOCAL_INLINE boolean Com_Lok_IPduBasedTimeoutMonitoring(Type_SwcServiceCom_tIdPdu RxPduId, boolean reloadDmTimer_b);

LOCAL_INLINE boolean Com_Lok_IPduBasedSigTimeoutAction(Type_SwcServiceCom_tIdPdu RxPduId);

#ifdef COM_RX_SIGNALGROUP
LOCAL_INLINE boolean Com_Lok_IPduBasedSigGrpTimeoutAction(Type_SwcServiceCom_tIdPdu RxPduId);
#endif

#endif

#ifdef COM_RxSigUpdateTimeout
LOCAL_INLINE boolean Com_Lok_SigBasedTimeoutMonitoring(Type_SwcServiceCom_tIdPdu RxPduId);
#endif

#ifdef COM_RxSigGrpUpdateTimeout
LOCAL_INLINE boolean Com_Lok_SigGrpBasedTimeoutMonitoring(Type_SwcServiceCom_tIdPdu RxPduId);
#endif

#ifdef COM_RxIPduDeferredProcessing
LOCAL_INLINE void Com_ProcessDeferredRxIpdu(Type_SwcServiceCom_tIdPdu PduId);
#endif

#ifdef COM_RXIPDU_TP_INVALIDATION

#ifdef COM_RxSigInvalid
LOCAL_INLINE void Com_ExecuteRxSigInvalidActions(Type_SwcServiceCom_tIdPdu PduId);
#endif

#ifdef COM_RxSigGrpInvalid
LOCAL_INLINE void Com_ExecuteRxSigGrpInvalidActions(Type_SwcServiceCom_tIdPdu PduId);
#endif
...
# endif
        ...
        for( ; idx_IpduId_u16 < numOfIpdus; idx_IpduId_u16++)
        {
            ...
            if(Com_CheckRxIPduStatus((Type_SwcServiceCom_tIdPdu)idx_IpduId_u16))
            {
...
# ifdef COM_RxIPduDeferredProcessing
                    ...
                    {
                        Com_ProcessDeferredRxIpdu((Type_SwcServiceCom_tIdPdu)idx_IpduId_u16);
                    }
# endif
...
# if defined(COM_RxIPduTimeout) || defined(COM_RxSigUpdateTimeout) || defined(COM_RxSigGrpUpdateTimeout)
                ...
                Com_Lok_RxTimeoutProcessing((Type_SwcServiceCom_tIdPdu)idx_IpduId_u16, rxIndication_b);
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
boolean Com_ProvideRxIpduStatus(Type_SwcServiceCom_tIdPdu PduId)
{
   boolean     pduStatus_b;
...
LOCAL_INLINE void Com_ProcessDeferredRxIpdu(Type_SwcServiceCom_tIdPdu PduId)
{
   Com_RxIpduConstPtrType  RxIpduConstPtr;
   Com_RxIpduRamPtrType    RxIpduRamPtr;
   Type_SwcServiceCom_stInfoPdu             comRxPduInfo;
...
void Com_ExecuteRxInvalidActions(Type_SwcServiceCom_tIdPdu PduId)
{
#ifdef COM_RxSigInvalid
