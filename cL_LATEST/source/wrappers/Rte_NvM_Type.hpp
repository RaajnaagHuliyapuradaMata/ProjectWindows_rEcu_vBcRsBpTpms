...
#define NvMConf_NvMBlockDescriptor_DemStatusDataBlock      NvMConf_NvMBlockDescriptor_NvMBlock_DemNvm_IdEvStatusByte
#define NvMConf_NvMBlockDescriptor_DemPrimaryDataBlock0    NvMConf_NvMBlockDescriptor_NvMBlock_DemNvm_IdEvMemLoc0
#define NvMConf_NvMBlockDescriptor_DemPrimaryDataBlock1    NvMConf_NvMBlockDescriptor_NvMBlock_DemNvm_IdEvMemLoc1
#define NvMConf_NvMBlockDescriptor_DemPrimaryDataBlock2    NvMConf_NvMBlockDescriptor_NvMBlock_DemNvm_IdEvMemLoc2
#define NvMConf_NvMBlockDescriptor_DemPrimaryDataBlock3    NvMConf_NvMBlockDescriptor_NvMBlock_DemNvm_IdEvMemLoc3
#define NvMConf_NvMBlockDescriptor_DemPrimaryDataBlock4    NvMConf_NvMBlockDescriptor_NvMBlock_DemNvm_IdEvMemLoc4
#define NvMConf_NvMBlockDescriptor_DemPrimaryDataBlock5    NvMConf_NvMBlockDescriptor_NvMBlock_DemNvm_IdEvMemLoc5
#define NvMConf_NvMBlockDescriptor_DemPrimaryDataBlock6    NvMConf_NvMBlockDescriptor_NvMBlock_DemNvm_IdEvMemLoc6
#define NvMConf_NvMBlockDescriptor_DemPrimaryDataBlock7    NvMConf_NvMBlockDescriptor_NvMBlock_DemNvm_IdEvMemLoc7
#define NvMConf_NvMBlockDescriptor_DemPrimaryDataBlock8    NvMConf_NvMBlockDescriptor_NvMBlock_DemNvm_IdEvMemLoc8
#define NvMConf_NvMBlockDescriptor_DemPrimaryDataBlock9    NvMConf_NvMBlockDescriptor_NvMBlock_DemNvm_IdEvMemLoc9
#define NvMConf_NvMBlockDescriptor_DemAdminDataBlock       NvMConf_NvMBlockDescriptor_NvMBlock_DemNvm_IdDemGenericNvData
...
extern void Memstack_Main(void);         // to be called every 10ms
