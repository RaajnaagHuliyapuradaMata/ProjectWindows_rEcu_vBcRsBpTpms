...
void Dem_Dependencies_SetNodeFailedNotRecoverable(Dem_ComponentIdType NodeId);
...
DEM_INLINE void Dem_Dependencies_SetNodeFailedNotRecoverable(Dem_ComponentIdType NodeId)
{
    DEM_UNUSED_PARAM(NodeId);
}
