...
void EcuM_SetWakeupEvent( Type_SwcServiceEcuM_tSourceWakeup sources )
{
   ...
   uint8 ctrLoop_u8 = 0;
    ...
    EcuM_Lok_SleepType_Enum_ten id_RequestedSleepType_en = ECUM_PRV_NO_SLEEP_E;
...
void EcuM_ValidateWakeupEvent( Type_SwcServiceEcuM_tSourceWakeup sources )
{
   ...
   uint32 EcuM_CommchlWkupEvents_u32 = 0;
    ...
    // Variable used to hold only the wakeup sources with Comm channel reference from the passed sources
    Type_SwcServiceEcuM_tSourceWakeup dataPendingWakeupEvents_u32 = 0;
...
void EcuM_ClearWakeupEvent ( Type_SwcServiceEcuM_tSourceWakeup sources )
{
...
Type_SwcServiceEcuM_tSourceWakeup EcuM_GetPendingWakeupEvents(void)
{
...
Type_SwcServiceEcuM_tSourceWakeup EcuM_GetValidatedWakeupEvents(void)
{
...
Type_SwcServiceEcuM_tSourceWakeup EcuM_GetExpiredWakeupEvents(void)
{
...
void EcuM_EndCheckWakeup(Type_SwcServiceEcuM_tSourceWakeup sources)
{
#if(ECUM_SLEEP_SUPPORT_ENABLE == TRUE)
