...
void ClientIf_Debug_CanMsgTransmit(uint16 uiCanMsgID,Type_SwcApplTpms_stMessageCan* spCAN_Message,uint8 ucReturnVal){
}

void ClientIf_Debug_CanMsgReceive(uint16 uiCanMsgID,const Type_SwcApplTpms_stMessageCan* spCAN_Message,uint8 ucReturnVal){
}
