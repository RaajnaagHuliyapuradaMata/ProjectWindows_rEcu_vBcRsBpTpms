...
FUNC(boolean,COM_CODE) Com_IPdu_Callout_TPMS_ApplicationCyclic(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) id, P2VAR(Type_SwcServiceCom_stInfoPdu, AUTOMATIC, COM_APPL_DATA) ptr)
{
  Type_SwcApplTpms_stMessageCan tTPM_ApplicationCyclicMessage;
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
FUNC(boolean,COM_CODE) Com_IPdu_Callout_TPMS_TirePT(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) id, P2VAR(Type_SwcServiceCom_stInfoPdu, AUTOMATIC, COM_APPL_DATA) ptr)
{
  ...
  (void)HufIf_CanMsgTransmit(CAN_MSG_HMI_CYCLIC, (Type_SwcApplTpms_stMessageCan*)&tPressureData);

  (void)HufIf_CanMsgTransmit(CAN_MSG_HMI_TEMP_CYCLIC, (Type_SwcApplTpms_stMessageCan*)&tTemperatureData);
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
FUNC(boolean,COM_CODE) Com_IPdu_Callout_TPMS_Status(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) id, P2VAR(Type_SwcServiceCom_stInfoPdu, AUTOMATIC, COM_APPL_DATA) ptr)
{
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
FUNC(boolean,COM_CODE) Com_IPdu_Callout_TPMS_ApplicationResponse(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) id, P2VAR(Type_SwcServiceCom_stInfoPdu, AUTOMATIC, COM_APPL_DATA) ptr)
{
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
FUNC(boolean,COM_CODE) Com_IPdu_Callout_CGW_TPMS_ApplicationRequest(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) id, P2CONST(Type_SwcServiceCom_stInfoPdu, AUTOMATIC, COM_APPL_CONST) ptr) // UndCC_Line(MISRA12_8.2)
{
  uint8 AU8_Buffer[8];
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
FUNC(boolean,COM_CODE) Com_IPdu_Callout_TPMS_RdcData(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) id, P2CONST(Type_SwcServiceCom_stInfoPdu, AUTOMATIC, COM_APPL_CONST) ptr)
{
  uint8 AU8_Buffer[8];
  (void) rba_BswSrv_MemCopy(AU8_Buffer, ptr->SduDataPtr, ptr->SduLength);
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
FUNC(boolean,COM_CODE) Com_IPdu_Callout_CGW_EPOCHTime(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) id, P2CONST(Type_SwcServiceCom_stInfoPdu, AUTOMATIC, COM_APPL_CONST) ptr)
{
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
FUNC(boolean,COM_CODE) Com_IPdu_Callout_CGW_VCU_WheelSpeed_Front(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) id, P2CONST(Type_SwcServiceCom_stInfoPdu, AUTOMATIC, COM_APPL_CONST) ptr)
{
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
FUNC(boolean,COM_CODE) Com_IPdu_Callout_CGW_VCU_WheelSpeed_Rear(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) id, P2CONST(Type_SwcServiceCom_stInfoPdu, AUTOMATIC, COM_APPL_CONST) ptr)
{
  //Contains wheel speeds in km/h -> the 4 wheel speeds shall be used to calculate vehicle speed
  //Contains wheel directions also
  uint8 AU8_Buffer[8];
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
FUNC(boolean,COM_CODE) Com_IPdu_Callout_CGW_ESP_WheelPulses(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) id, P2CONST(Type_SwcServiceCom_stInfoPdu, AUTOMATIC, COM_APPL_CONST) ptr)
{
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
FUNC(boolean,COM_CODE) Com_IPdu_Callout_CGW_VCU_Ambient_Info(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) id, P2CONST(Type_SwcServiceCom_stInfoPdu, AUTOMATIC, COM_APPL_CONST) ptr)
{
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
FUNC(boolean,COM_CODE) Com_IPdu_Callout_BCM_PowerMode(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) id, P2CONST(Type_SwcServiceCom_stInfoPdu, AUTOMATIC, COM_APPL_CONST) ptr)
{
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
FUNC(boolean, COM_CODE) Com_IPdu_Callout_CGW_VCU_Powertrain_Info(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) id, P2CONST(Type_SwcServiceCom_stInfoPdu, AUTOMATIC, COM_APPL_CONST) ptr)
{
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
FUNC(boolean, COM_CODE) Com_IPdu_Callout_CGW_ODO(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) id, P2CONST(Type_SwcServiceCom_stInfoPdu, AUTOMATIC, COM_APPL_CONST) ptr)
{
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
FUNC(boolean, COM_CODE) Com_IPdu_Callout_CGW_VehicleSpeed(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) id, P2CONST(Type_SwcServiceCom_stInfoPdu, AUTOMATIC, COM_APPL_CONST) ptr)
{
