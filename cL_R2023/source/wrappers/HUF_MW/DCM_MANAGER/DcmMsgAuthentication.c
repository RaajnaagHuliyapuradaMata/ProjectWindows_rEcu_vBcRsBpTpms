...
#include "DcmMsgAuthentication.h"
#include "hmac_sha2.h"
...
//static const uint16 aushAuthList[NO_OF_SID][NO_OF_DID_RID] = { { cSidReadDataByIdent , cDidBootSwFingerprint, cDidApplSwFingerprint, cDidProgImgBL     , cDidProgImgAPP1  , cDidKeyGenCounters, cDidManufSuppMode, cDidEepBlockStatus },
//                                                               { cSidWriteDataByIdent, cDidBootSwFingerprint, cDidApplSwFingerprint, cDidKeyGenCounters, cDidManufSuppMode, 0, 0, 0 },
//                                                               { cSidRoutineControl  , cRidSelfTest         , cRidKeyExchange      , 0, 0, 0, 0, 0 },
//                                                               { cSidEcuReset        , cSubFuncHardReset    , cSubFuncSoftReset    , cSubFuncHRwoResp  , cSubFuncSRwoResp , cSubFuncResUDSTimer, 0, 0 } };

#endif //DEBUG_IGNORE_MESSAGE_AUTHENTICATION
