...
//------- Fixed area (only change if you want to have trouble with BHSENS production line) -----------    Content acc. to Flash_Organisation_LMC_2021-10-18_V1.xlsx
#define DCM__PRODUCTION_DATA_INDEX_1_SIZE       (16U)   //to be filled with 0xff
#define DCM__PRODUCTION_DATA_INDEX_2_SIZE       (10U)   //Customer HW part number 433                     ALEB-003AA
#define DCM__PRODUCTION_DATA_INDEX_3_SIZE       (10U)   //Customer HW part number 315                     ALUF-003AA
#define DCM__PRODUCTION_DATA_INDEX_4_SIZE       (3U)    //Huf specific HW ident number 433                H06
#define DCM__PRODUCTION_DATA_INDEX_5_SIZE       (3U)    //Huf specific HW ident number 315                H06
#define DCM__PRODUCTION_DATA_INDEX_6_SIZE       (3U)    //Hardware version info                           Year Week Cont.number (Hex)
#define DCM__PRODUCTION_DATA_INDEX_7_SIZE       (10U)   //Customer LU Sachnummer 433 (Daimler)            ALEB-003AA
#define DCM__PRODUCTION_DATA_INDEX_8_SIZE       (10U)   //Customer LU Sachnummer 315 (Daimler)            ALUF-003AA
#define DCM__PRODUCTION_DATA_INDEX_9_SIZE       (2U)    //Supplier number                                 02 (Ascii)
#define DCM__PRODUCTION_DATA_INDEX_10_SIZE      (6U)    //Production day                                  YY MM DD (Ascii)
#define DCM__PRODUCTION_DATA_INDEX_11_SIZE      (9U)    //Customer ECU serial number                      last 9 digits of iTac           82 Bytes
//------- Rivian specific area -----------------------------------------------------------------------
#define DCM__PRODUCTION_DATA_INDEX_12_SIZE      (20U)   //Rivian: APPL SW Fingerprint Tester serial       n/a (filled with 0x30)
#define DCM__PRODUCTION_DATA_INDEX_13_SIZE      (3U)    //Rivian: APPL SW Fingerprint Programming date    n/a (filled with 0x00)
#define DCM__PRODUCTION_DATA_INDEX_14_SIZE      (20U)   //Rivian: BL Fingerprint Tester serial number     n/a (filled with 0x30)
#define DCM__PRODUCTION_DATA_INDEX_15_SIZE      (3U)    //Rivian: BL Fingerprint Programming date         n/a (filled with 0x00)
#define DCM__PRODUCTION_DATA_INDEX_16_SIZE      (17U)   //Rivian: VIN                                     Vin
#define DCM__PRODUCTION_DATA_INDEX_17_SIZE      (1U)    //Rivian: Manufacturing Support Mode              n/a                             64 Bytes
                                                        //--- Genealogy Block start ---                   n/a
#define DCM__PRODUCTION_DATA_INDEX_18_SIZE      (1U)    //Rivian: Genealogy Version                       n/a
#define DCM__PRODUCTION_DATA_INDEX_19_SIZE      (2U)    //Rivian: Component ID                            n/a
#define DCM__PRODUCTION_DATA_INDEX_20_SIZE      (1U)    //Rivian: PCBA ID                                 n/a
#define DCM__PRODUCTION_DATA_INDEX_21_SIZE      (1U)    //Rivian: Aux ID                                  n/a
#define DCM__PRODUCTION_DATA_INDEX_22_SIZE      (2U)    //Rivian: Mode ID                                 n/a
#define DCM__PRODUCTION_DATA_INDEX_23_SIZE      (35U)   //Rivian: Board part number                       n/a
#define DCM__PRODUCTION_DATA_INDEX_24_SIZE      (18U)   //Rivian: Board Serial number                     n/a
#define DCM__PRODUCTION_DATA_INDEX_25_SIZE      (35U)   //Rivian: ECU part number                         n/a
#define DCM__PRODUCTION_DATA_INDEX_26_SIZE      (18U)   //Rivian: ECU serial number                       n/a
#define DCM__PRODUCTION_DATA_INDEX_27_SIZE      (16U)   //Rivian: Application Signature                   n/a
#define DCM__PRODUCTION_DATA_INDEX_28_SIZE      (4U)    //Rivian: Genealogy CRC32                         n/a                             133 Bytes
                                                        //--- Genealogy Block end ---
#define DCM__PRODUCTION_DATA_INDEX_29_SIZE      (1U)    //BHSENS EOL Checker Byte                         0xAA
#define DCM__PRODUCTION_DATA_INDEX_30_SIZE      (40)    //Free (until end of flash block 4)               0xFF
