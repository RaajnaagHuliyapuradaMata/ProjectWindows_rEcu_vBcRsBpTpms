...
extern uint8 PRODFLASH_GetBhsensHwVersionInfo(uint8* ucData);
extern uint8 PRODFLASH_GetBhsensProductionDate(uint8* ucData);
extern uint8 PRODFLASH_GetApplicationChecksum(uint8* ucData);
extern uint8 PRODFLASH_GetBhsensHardwareNumber(uint8* ucData);
extern uint8 PRODFLASH_GetProgrammingDate(uint8* ucData);
...
extern void PRODFLASH_PutProgrammingDate(const uint8* ucData);
extern void PRODFLASH_PutCustomerEcuSerialNumber(const uint8* ucData);
