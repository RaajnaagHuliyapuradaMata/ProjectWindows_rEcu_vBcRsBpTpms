...
#define cCAN_COMM_TIMEOUT 300 // =3sec
#define cCAN_EXTENDED_COMM_TIMOUT 2000 // =20sec

#define CANMGR__IGNITION_ON_TRESHOLD ((uint8) 1U) // LMC: ign is on when power mode > 1
...
#define CANMGR__WSPEED_QUALIFIER_BIT_NOT_INITIALIZED					((uint8)0x02) //((uint8) 0x00U)
#define CANMGR__WSPEED_QUALIFIER_BIT_NORMAL										((uint8)0x00) //((uint8) 0x01U)
#define CANMGR__WSPEED_QUALIFIER_BIT_FAULT										((uint8)0x01) //((uint8) 0x02U)
...
//typedef struct
//{
//  //bitfield bWheelPulseRR : 10;
//  //bitfield b6Gap1 : 6;
//  //bitfield bWheelPulseRL : 10;
//  //bitfield b6Gap2 : 6;
//  //bitfield bWheelPulseFL : 10;
//  //bitfield b6Gap3 : 6;
//  //bitfield bWheelPulseFR : 10;
//  //bitfield b6Gap4 : 6;
//  // RST Debug LMC 20.10.2021: E7 telegramme werden nicht verarbeitet
//}sWheelPulses_LMC;
