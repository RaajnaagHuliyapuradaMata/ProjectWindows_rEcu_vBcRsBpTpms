...
LOCAL_INLINE boolean Dcm_Lok_CheckLowPriorityRequestReceived(PduIdType DcmRxPduId)
{
...
LOCAL_INLINE boolean Dcm_Lok_isConsecutiveRequestReceived(PduIdType DcmRxPduId)
{
#if(DCM_CFG_PROTOCOL_PREMPTION_ENABLED == DCM_CFG_OFF)
    (void)DcmRxPduId;
#endif
...
LOCAL_INLINE PduLengthType Dcm_Lok_GetRequestLength(PduIdType DcmRxPduId)
{
...
void Dcm_Lok_ResetCopyRxDataStatus (PduIdType RxPduId)
{
...
static void Dcm_Lok_DiscardRequest(PduIdType DcmRxPduId,
...
static void Dcm_Lok_ProcessHighPriorityRequest(PduIdType DcmRxPduId)
{
...
static void Dcm_Lok_ProcessHighPriorityReqWhileRoeEvent(PduIdType DcmRxPduId)
{
...
static void Dcm_Lok_ReloadP2maxValue(PduIdType DcmRxPduId,uint8 idxProtocol_u8)
{
#if(DCM_CFG_KWP_ENABLED != DCM_CFG_OFF)
...
static void Dcm_Lok_OBDSendNRC21(PduIdType DcmRxPduId)
{
...
void Dcm_Lok_ResetOBDCopyRxDataStatus(PduIdType id)
{
...
static void Dcm_Lok_AcceptOBDRequest(PduIdType id)
{
...
static void Dcm_Lok_DiscardOBDRequest(PduIdType id,Std_ReturnType Result)
{
#if(DCM_CALLAPPLICATIONONREQRX_ENABLED != DCM_CFG_OFF)
...
static void Dcm_Lok_OBDRxIndication(PduIdType DcmRxPduId)
{
...
static void Dcm_Lok_ProcessRequest(PduIdType DcmRxPduId)
{
    uint8 idxProtocol_u8 = Dcm_DsldConnTable_pcst[Dcm_DsldRxTable_pcu8[DcmRxPduId]].protocol_num_u8;
...
static void Dcm_Lok_SendNrc21(PduIdType DcmRxPduId)
{
    PduInfoType pduInfo_st = {NULL_PTR,NULL_PTR,DCM_NEGATIVE_RESPONSE_LENGTH};
...
static void Dcm_Lok_CheckDiagnosticStatus(PduIdType DcmRxPduId,
...
static void Dcm_Lok_UpdateDSLstate(PduIdType DcmRxPduId)
{
...
static boolean Dcm_Lok_isFunctionalTesterPresentProcessed(PduIdType DcmRxPduId)
{
...
static boolean Dcm_Lok_isRequestQueued(PduIdType DcmRxPduId,
        Std_ReturnType Result)
{
...
static void Dcm_Lok_ProcessSharedPduId(PduIdType * RxPduIdPtr)
{
...
static void Dcm_Lok_ProcessRxIndication(PduIdType DcmRxPduId)
{
    uint8 idxProtocol_u8  = Dcm_DsldConnTable_pcst[Dcm_DsldRxTable_pcu8[DcmRxPduId]].protocol_num_u8;
