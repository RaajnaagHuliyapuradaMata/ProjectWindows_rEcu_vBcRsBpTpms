...
Std_ReturnType Dcm_DcmObdMode01 (Dcm_SrvOpStatusType OpStatus,Dcm_MsgContextType * pMsgContext,Dcm_NegativeResponseCodeType * dataNegRespCode_u8)
{
...
#endif
    uint32 dataPIDMaskVal_u32;
    uint32 dataCalPIDBitMask_u32;
    uint32 dataPidRunTimeMask_u32;
    Dcm_MsgLenType nrResMaxDataLen_u32;
    Dcm_MsgLenType nrReqDataLen_u32;
    uint16_least idxPIDRes_qu16;
    uint16 idxSupportInfo_u16;
    ...
    uint16 idxLoop_u16;
#endif
    uint16 posnPidData_u16;
#if (DCM_CFG_DSP_OBDMODE1_SINT16_SR_ENABLED != DCM_CFG_OFF)
    sint16 dataSignal_s16;
#endif
    uint8_least nrPid_qu8;
    uint8_least idxPIDStart_qu8;
    uint8_least idxPIDData_qu8;
    uint8_least nrPIDChk_qu8;
    uint8 adrTmpBuf_au8[DCM_OBDMODE01_REQ_LEN_MAX];
    uint8 idxPID_u8;
    uint8 nrMultiple_u8;
    uint8 dataSupportInfoByte_u8;
    Std_ReturnType dataGetPIDRetVal_u8;
    Std_ReturnType dataReturnValue_u8;
    boolean stPIDFound_b;
                                                ...
                                                if(Dcm_Dsp_Mode1DataSourcePid_acs[idxDataSource_u16].PidUsePort == OBD_USE_DATA_SENDER_RECEIVER)
                                                {
                                                    ...
                                                    if(Dcm_Dsp_Mode1DataSourcePid_acs[idxDataSource_u16].dataType_u8 == DCM_UINT8)
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            dataGetPIDRetVal_u8 = (*(GetPIDvalue1_pf)(Dcm_Dsp_Mode1DataSourcePid_acs[idxDataSource_u16].GetPIDvalue_pf))(Dcm_ObdArraySignal_au8);
                                                        }
                                                    ...
                                                    else if(Dcm_Dsp_Mode1DataSourcePid_acs[idxDataSource_u16].dataType_u8 == DCM_UINT16)
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            dataGetPIDRetVal_u8 = (*(GetPIDvalue2_pf)(Dcm_Dsp_Mode1DataSourcePid_acs[idxDataSource_u16].GetPIDvalue_pf))(Dcm_ObdArraySignal_au16);
                                                        }
                                                    ...
                                                    else if(Dcm_Dsp_Mode1DataSourcePid_acs[idxDataSource_u16].dataType_u8 == DCM_UINT32)
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            dataGetPIDRetVal_u8 = (*(GetPIDvalue3_pf)(Dcm_Dsp_Mode1DataSourcePid_acs[idxDataSource_u16].GetPIDvalue_pf))(Dcm_ObdArraySignal_au32);
                                                        }
                                                    ...
                                                    else if(Dcm_Dsp_Mode1DataSourcePid_acs[idxDataSource_u16].dataType_u8 == DCM_SINT8)
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            dataGetPIDRetVal_u8 = (*(GetPIDvalue4_pf)(Dcm_Dsp_Mode1DataSourcePid_acs[idxDataSource_u16].GetPIDvalue_pf))(Dcm_ObdArraySignal_as8);
                                                        }
                                                    ...
                                                    else if(Dcm_Dsp_Mode1DataSourcePid_acs[idxDataSource_u16].dataType_u8 == DCM_SINT16)
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            dataGetPIDRetVal_u8 = (*(GetPIDvalue5_pf)(Dcm_Dsp_Mode1DataSourcePid_acs[idxDataSource_u16].GetPIDvalue_pf))(Dcm_ObdArraySignal_as16);
                                                        }
                                                    ...
                                                    else if(Dcm_Dsp_Mode1DataSourcePid_acs[idxDataSource_u16].dataType_u8 == DCM_SINT32)
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            dataGetPIDRetVal_u8 = (*(GetPIDvalue6_pf)(Dcm_Dsp_Mode1DataSourcePid_acs[idxDataSource_u16].GetPIDvalue_pf))(Dcm_ObdArraySignal_as32);
                                                        }
