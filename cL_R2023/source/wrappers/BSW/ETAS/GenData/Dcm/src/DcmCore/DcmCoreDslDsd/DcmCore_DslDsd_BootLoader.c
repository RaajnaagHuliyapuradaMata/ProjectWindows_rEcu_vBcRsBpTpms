...
Dcm_BootLoaderStates_ten Dcm_BootLoaderState_en;
static Dcm_OpStatusType s_Dcm_SetProgCondOpstatus_u8;
static Std_ReturnType Dcm_StoreReturnValue_u8;
#define DCM_STOP_SEC_VAR_CLEARED_UNSPECIFIED
#include "Dcm_MemMap.h"
#define DCM_START_SEC_CODE
#include "Dcm_MemMap.h"
static Std_ReturnType Dcm_TimerRemaining(uint32 timer,uint32 startTime,Std_ReturnType * timerStatus);
static Std_ReturnType Dcm_SendForcedResponsePend(void);
static void Dcm_InvokeSetProgCondition(boolean * flag_b, Dcm_NegativeResponseCodeType * dataNegRespCode_u8);

void Dcm_JumpToBootLoader(uint8 dataBootType_u8, Dcm_NegativeResponseCodeType * dataNegRespCode_u8)
{

    uint8 dataProtocolId_u8;
    Dcm_SesCtrlType dataSessionId_u8;
    Dcm_SecLevelType dataSecurityLevel_u8;
    Std_ReturnType dataReturnValue_u8;
    boolean flgProcessSrv_b;
    uint8 serviceId;
...
static void Dcm_InvokeSetProgCondition(boolean * flag_b, Dcm_NegativeResponseCodeType * dataNegRespCode_u8)
{
    Std_ReturnType dataRetProgCond_u8;
