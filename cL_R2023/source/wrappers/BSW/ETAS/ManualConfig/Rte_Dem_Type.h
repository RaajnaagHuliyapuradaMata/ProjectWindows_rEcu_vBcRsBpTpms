...
//RST integration code (LMC): again a define that is not generated by configuration tool
//Hint: there is a checking functionality in Dem_EvMem.c line 108!!! There it is visible how 0x05 and 0x06 shall be declared:
#define DEM_DTC_ORIGIN_OBD_RELEVANT_MEMORY 0x04
#define DEM_DTC_ORIGIN_SECONDARY_MEMORY 0x05
