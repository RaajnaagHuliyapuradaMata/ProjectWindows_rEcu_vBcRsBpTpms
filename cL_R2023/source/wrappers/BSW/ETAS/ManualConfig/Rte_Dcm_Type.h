...
typedef enum
{
  ...
  DCM_OBD_ON_KLINE              = 0x0D, //RST integration code: this is not defined in Autosar 4.2.2 DCM spec, but freaky BSW 6.0.0 generated code
                                        //uses this define in Dcm_Dsl_StateMachine.c line 838. So I just set it to 0xD here...
} Dcm_ProtocolType;
