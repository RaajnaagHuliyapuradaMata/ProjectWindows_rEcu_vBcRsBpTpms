...
extern FUNC(void, OS_CALLOUT_CODE) StartupHook_HufTpms(void) ;
extern FUNC(void, OS_CALLOUT_CODE) ShutdownHook_HufTpms(StatusType Error) ;
extern FUNC(void, OS_CALLOUT_CODE) ErrorHook_HufTpms(StatusType Error) ;
extern FUNC(void, OS_CALLOUT_CODE) Os_Cbk_Alarm_CB_Alarm10ms(void);
extern FUNC(void, OS_CALLOUT_CODE) Os_Cbk_Alarm_CB_AlarmOneSecond(void);
extern FUNC(void, OS_CALLOUT_CODE) Os_Cbk_Alarm_CB_Alarm200ms(void);
extern FUNC(void, OS_CALLOUT_CODE) Os_Cbk_Alarm_CB_Alarm50ms(void);
...
#define OS_INDEX_FOR_CyclicTask1sec (0U)
...
#define OS_INDEX_FOR_CyclicTask50ms (1U)
...
#define OS_INDEX_FOR_CyclicTask200ms (2U)
...
#define OS_INDEX_FOR_CyclicTask10ms (3U)
...
#define OS_INDEX_FOR_CanRecTask (4U)
...
#define OS_INDEX_FOR_CAT2ISR_CanGlobalStatus (7U)
...
#define OS_INDEX_FOR_FLS_FLENDNM_CAT2_ISR (10U)
