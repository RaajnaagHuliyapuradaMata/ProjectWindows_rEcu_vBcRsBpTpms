...
#define FBL_NV_CONTROL_DATA_FEE_BLOCK_LENGTH                   130u
...
extern tFblResult ApplFblNvWriteProcessData (vuint16 blockOffset, const V_MEMRAM1 vuint8  V_MEMRAM2 V_MEMRAM3* pBuffer,                     vuint16 length);
extern tFblResult ApplFblNvReadProcessData  (vuint16 blockOffset,       V_MEMRAM1 vuint8  V_MEMRAM2 V_MEMRAM3* pBuffer,                     vuint16 length);
extern tFblResult ApplFblNvWriteMetaData    (vuintx index,                        vuint16                      blockOffset, const V_MEMRAM1 vuint8 V_MEMRAM2 V_MEMRAM3* pBuffer, vuint16 length );
extern tFblResult ApplFblNvReadMetaData     (vuintx index,                        vuint16                      blockOffset,       V_MEMRAM1 vuint8 V_MEMRAM2 V_MEMRAM3* pBuffer, vuint16 length );
static tFblResult ApplFblNvRead             (vuint16 blockNumber,                 vuint16                      blockOffset,       V_MEMRAM1 vuint8 V_MEMRAM2 V_MEMRAM3* pBuffer, vuint16 length );
static tFblResult ApplFblNvWrite            (vuint16 blockNumber,       V_MEMRAM1 vuint8  V_MEMRAM2 V_MEMRAM3* pBuffer);
   ...
   if(E_OK == EcuabFee_Read(blockNumber, blockOffset, pBuffer, length)){
      ...
      if(MEMIF_JOB_OK == feeJobResult){
         result = kFblOk;
            ...
            (MEMIF_BLOCK_INCONSISTENT == feeJobResult)
...
static tFblResult ApplFblNvWrite(
      vuint16 blockNumber
   ,  V_MEMRAM1 vuint8 V_MEMRAM2 V_MEMRAM3* pBuffer
){
   tFblResult result;
...
tFblResult ApplFblNvWriteProcessData(
                      vuint16 blockOffset
   ...
   if(0u == g_FblNvDataCached){
      result = ApplFblNvRead(
            FBL_NV_CONTROL_DATA_FEE_BLOCK_NUMBER
         ,  0u
         ,  g_FblNvData
...
tFblResult ApplFblNvWriteMetaData(
                      vuintx                      index
   ,                  vuint16                     blockOffset
   ,  const V_MEMRAM1 vuint8 V_MEMRAM2 V_MEMRAM3* pBuffer
   ,                  vuint16                     length
   ...
   if(0u == g_FblNvDataCached){
      result = ApplFblNvRead(
            FBL_NV_META_DATA_FEE_BLOCK_NUMBER(index)
         ,  0u
         ,  g_FblNvData
...
tFblResult ApplFblNvReadMetaData(
                vuintx                      index
   ,            vuint16                     blockOffset
   ,  V_MEMRAM1 vuint8 V_MEMRAM2 V_MEMRAM3* pBuffer
   ,            vuint16                     length
