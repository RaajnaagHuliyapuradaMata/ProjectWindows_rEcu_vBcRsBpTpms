...
// RST Info: this is original applvect.h from demo application
...
#include "ApplVect_Memmap.h"
    ...
    // RST Info: this is copied from FblBmHdr_Cfg.h and fbl_def.h of demo application -> definition of the application header
    ...
    // RST Info: this is copied from bm_types.h of bootloader code -> definition of the bm header for jumping to fbl from application
