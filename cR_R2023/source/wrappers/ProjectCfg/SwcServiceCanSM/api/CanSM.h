...
typedef struct
{
    ...
    P2FUNC(uint16, TYPEDEF,pBorTimeL1_pfct)(void);
    P2FUNC(uint16, TYPEDEF,pBorTimeL2_pfct)(void);
#else
    ...
    VAR(boolean, TYPEDEF)               BorTxConfPolling_b;
#endif
...
#include "CanSM_MemMap.h"
extern const Type_CfgSwcServiceCanSM_st CanSM_ConfigSet[];
