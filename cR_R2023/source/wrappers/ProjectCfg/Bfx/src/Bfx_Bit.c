...
#include "Bfx.h"
    ...
    {
        Bfx_Lok_CopyBit_u16u8u16u8_Inl(DestData, DestPn, SrcData, SrcPn);
    }
    ...
    {
        Bfx_Lok_CopyBit_u32u8u32u8_Inl(DestData, DestPn, SrcData, SrcPn);
    }
    ...
    {
        Bfx_Lok_CopyBit_u8u8u8u8_Inl(DestData, DestPn, SrcData, SrcPn);
    }
    ...
    {
        Bfx_Lok_PutBit_u16u8u8_Inl(Data, BitPn, Value);
    }
    ...
    {
        Bfx_Lok_PutBit_u32u8u8_Inl(Data, BitPn, Value);
    }
    ...
    {
        Bfx_Lok_PutBit_u8u8u8_Inl(Data, BitPn, Value);
    }
