...
// | CAT01                                   | CAT02                                               | ... | CAT10     |   <--- Category = FEE Block
// | Block 0   | Block 1   | ... | Block 12  | Block 13  | Block 14  | Block 15  | ... | Block 25  | ... | Block 99  |   <--- Huf Block Number
// | Byte 0..3 | Byte 0..3 | ... | Byte 0..3 | Byte 0..3 | Byte 0..3 | Byte 0..3 | ... | Byte 0..3 | ... | Byte 0..3 |   <--- Each Huf Block has 4 Bytes
...
void infSwcServiceNvMSwcApplEcuM_InitFunction(void)
{
    ...
    //NvM_WriteBlock(NvMConf_NvMBlockDescriptor_NvMBlock_BSW_Data, (uint8*)&Ram_NvMBlock_BSW_Data[0]);
}
...
extern void Memstack_WriteAllBlocks(void)
{
  ...
  WriteData2GildasBlock();

  NvM_WriteBlock(NvMConf_NvMBlockDescriptor_NvMBlock_Gildas, (uint8*)&Ram_NvMBlock_Gildas[0]);

  NvM_WriteBlock(NvMConf_NvMBlockDescriptor_NvMBlock_CAT01, (uint8*)&Ram_NvMBlock_CAT01[0]);
  NvM_WriteBlock(NvMConf_NvMBlockDescriptor_NvMBlock_CAT02, (uint8*)&Ram_NvMBlock_CAT02[0]);
  NvM_WriteBlock(NvMConf_NvMBlockDescriptor_NvMBlock_CAT03, (uint8*)&Ram_NvMBlock_CAT03[0]);
  NvM_WriteBlock(NvMConf_NvMBlockDescriptor_NvMBlock_CAT04, (uint8*)&Ram_NvMBlock_CAT04[0]);
  NvM_WriteBlock(NvMConf_NvMBlockDescriptor_NvMBlock_CAT05, (uint8*)&Ram_NvMBlock_CAT05[0]);
  NvM_WriteBlock(NvMConf_NvMBlockDescriptor_NvMBlock_CAT06, (uint8*)&Ram_NvMBlock_CAT06[0]);
  NvM_WriteBlock(NvMConf_NvMBlockDescriptor_NvMBlock_CAT07, (uint8*)&Ram_NvMBlock_CAT07[0]);
  NvM_WriteBlock(NvMConf_NvMBlockDescriptor_NvMBlock_CAT08, (uint8*)&Ram_NvMBlock_CAT08[0]);
  NvM_WriteBlock(NvMConf_NvMBlockDescriptor_NvMBlock_CAT09, (uint8*)&Ram_NvMBlock_CAT09[0]);
  NvM_WriteBlock(NvMConf_NvMBlockDescriptor_NvMBlock_CAT10, (uint8*)&Ram_NvMBlock_CAT10[0]);
  ...
  for (i = 1; i<=12; i++)
  {
      ...
      while ( ucRequestResult == NVM_REQ_PENDING );
  }
#endif
}
...
extern void Memstack_WriteBswNvmBlockOnEvent(void)
{
  NvM_WriteBlock(NvMConf_NvMBlockDescriptor_NvMBlock_BSW_Data, (uint8*)&Ram_NvMBlock_BSW_Data[0]);
}

extern void Memstack_DeleteDemBlocks(void)
{
  //rba_BswSrv_MemCopy(Ram_NvMBlock_DemNvm_IdDemGenericNvData, Rom_NvMBlock_DemNvm_IdDemGenericNvData, DEM_NVM_ID_DEM_GENERIC_NV_DATA_SIZE);
  //rba_BswSrv_MemCopy(Ram_NvMBlock_DemNvm_IdEvStatusByte, Rom_NvMBlock_DemNvm_IdEvStatusByte, DEM_NVM_ID_EVT_STATUSBYTE_SIZE);
  //rba_BswSrv_MemCopy(Ram_NvMBlock_DemNvm_IdEvMemLoc0, Rom_NvMBlock_DemNvm_IdEvMemLoc0, DEM_NVM_ID_EVMEM_LOC_0_SIZE);
  //rba_BswSrv_MemCopy(Ram_NvMBlock_DemNvm_IdEvMemLoc1, Rom_NvMBlock_DemNvm_IdEvMemLoc1, DEM_NVM_ID_EVMEM_LOC_1_SIZE);
  //rba_BswSrv_MemCopy(Ram_NvMBlock_DemNvm_IdEvMemLoc2, Rom_NvMBlock_DemNvm_IdEvMemLoc2, DEM_NVM_ID_EVMEM_LOC_2_SIZE);
  //rba_BswSrv_MemCopy(Ram_NvMBlock_DemNvm_IdEvMemLoc3, Rom_NvMBlock_DemNvm_IdEvMemLoc3, DEM_NVM_ID_EVMEM_LOC_3_SIZE);
  //rba_BswSrv_MemCopy(Ram_NvMBlock_DemNvm_IdEvMemLoc4, Rom_NvMBlock_DemNvm_IdEvMemLoc4, DEM_NVM_ID_EVMEM_LOC_4_SIZE);
  //rba_BswSrv_MemCopy(Ram_NvMBlock_DemNvm_IdEvMemLoc5, Rom_NvMBlock_DemNvm_IdEvMemLoc5, DEM_NVM_ID_EVMEM_LOC_5_SIZE);
