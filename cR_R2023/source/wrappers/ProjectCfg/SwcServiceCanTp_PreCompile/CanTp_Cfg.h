...
#define CanTpConf_CanTpTxNSdu_UdsOnCan_Tx_Phy_TP                                ((PduIdType)0)

#define CanTpConf_CanTpRxNSdu_UdsOnCan_Rx_Func_RF                               ((PduIdType)0)
#define CanTpConf_CanTpRxNSdu_UdsOnCan_Rx_Phys_RP                               ((PduIdType)1)
...
typedef struct CanTp_ConfigStructType Type_CfgSwcServiceCanTp_st;
