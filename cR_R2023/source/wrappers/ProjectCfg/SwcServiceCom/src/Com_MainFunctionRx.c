...
FUNC(void, COM_CODE) Com_InternalMainFunctionRx( VAR(Com_MainFuncType,AUTOMATIC) RxMainFuncId )
{
    ...
    defined(COM_RxIPduTimeout) || defined(COM_RxSigUpdateTimeout) || defined(COM_RxSigGrpUpdateTimeout)
                ...
                Com_Lok_RxTimeoutProcessing((PduIdType)Idx_Pdu_ui, RxIndication_b);
...
LOCAL_INLINE FUNC(void, COM_CODE) Com_Lok_RxTimeoutProcessing( VAR(PduIdType, AUTOMATIC)   RxPduId,
                                                               VAR(boolean, AUTOMATIC)     RxIndication_b )
{
    Com_RxIpduConstPtrType  RxIPduConstPtr;
...
#ifdef COM_RxIPduTimeout
LOCAL_INLINE FUNC(boolean,COM_CODE) Com_Lok_IPduBasedSigTimeoutAction( VAR(PduIdType, AUTOMATIC)   RxPduId )
{
    Com_RxIpduConstPtrType                  RxIPduConstPtr;
...
LOCAL_INLINE FUNC(boolean,COM_CODE) Com_Lok_IPduBasedSigGrpTimeoutAction( VAR(PduIdType, AUTOMATIC)   RxPduId )
{
    Com_RxIpduConstPtrType                  RxIPduConstPtr;
#ifdef COM_RX_SIGNALGROUP
...
LOCAL_INLINE FUNC(boolean, COM_CODE) Com_Lok_SigBasedTimeoutMonitoring( VAR(PduIdType, AUTOMATIC)  RxPduId )
{
    Com_RxIpduConstPtrType                                      RxIPduConstPtr;
    Com_RxSigConstPtrType                                       RxSigConstPtr;
#if (defined(COM_SIGNALGATEWAY) || (defined (COM_RxFilters) && defined (COM_F_MASKEDNEWDIFFERSOLD)))
...
LOCAL_INLINE FUNC(boolean, COM_CODE) Com_Lok_SigGrpBasedTimeoutMonitoring( VAR(PduIdType, AUTOMATIC) RxPduId )
{
    Com_RxIpduConstPtrType                                      RxIPduConstPtr;
    Com_RxSigGrpConstPtrType                                    RxSigGrpConstPtr;
#if defined (COM_SIGNALGROUPGATEWAY) || (defined (COM_RxFilters) && defined (COM_F_MASKEDNEWDIFFERSOLD))
