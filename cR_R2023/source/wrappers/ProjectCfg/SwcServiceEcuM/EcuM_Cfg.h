...
#include "infMcalMcuSwcApplEcuM.h" //TBD: change to Types_McalMcu.hpp
...
extern CONST( uint8, ECUM_CONST ) EcuM_Cfg_dataPreCompileHash_au8[CfgSwcServiceEcuM_dLenHash];
