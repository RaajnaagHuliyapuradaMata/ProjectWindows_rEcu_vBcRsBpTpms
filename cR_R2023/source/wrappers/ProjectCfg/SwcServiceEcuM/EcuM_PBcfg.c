...
CONST( Type_CfgSwcServiceEcuM_st, ECUM_CONST ) EcuM_Config =
{
    OSDEFAULTAPPMODE,
...
CONSTP2CONST(Type_CfgSwcServiceEcuM_st,AUTOMATIC,ECUM_CONST) EcuM_EcuMConfigurations_cpcast[ECUM_NO_OF_ECUMCONFIGSETS]=
{
