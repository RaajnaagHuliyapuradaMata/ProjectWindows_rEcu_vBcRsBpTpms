...
static FUNC(void,DCM_CODE) Dcm_Lok_RestoreDddId(void)
{
...
static FUNC(void,DCM_CODE) Dcm_Lok_ROEInit(void)
{
...
static FUNC(void,DCM_CODE) Dcm_Lok_RdpiInit(void)
{
    P2CONST(Dcm_Dsld_protocol_tableType, AUTOMATIC, DCM_INTERN_CONST) adrProtocol_pcst;
...
static FUNC(void,DCM_CODE) Dcm_Lok_WarmStart(void)
{
...
static FUNC(void,DCM_CODE) Dcm_Lok_SecaInit(void)
{
...
static FUNC(void,DCM_CODE) Dcm_Lok_IOCBIIinit(void)
{
...
static FUNC(void,DCM_CODE) Dcm_Lok_UDSinit(void)
{
...
static FUNC(void,DCM_CODE) Dcm_Lok_BufqueueInit(void)
{
...
static FUNC(void,DCM_CODE) Dcm_Lok_ActiveConfigSet(void)
{
