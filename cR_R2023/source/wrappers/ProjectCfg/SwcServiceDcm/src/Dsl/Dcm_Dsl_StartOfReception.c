...
static FUNC(boolean,DCM_CODE) Dcm_Lok_CheckFunctionalTesterPresent( VAR(PduIdType, AUTOMATIC) DcmRxPduId,
...
static FUNC(BufReq_ReturnType,DCM_CODE) Dcm_Lok_InformApplication(VAR(PduIdType, AUTOMATIC) DcmRxPduId,
        P2CONST(PduInfoType, AUTOMATIC, DCM_APPL_DATA) infoPtr,VAR(PduLengthType, AUTOMATIC) TpSduLength,
        P2VAR(PduLengthType, AUTOMATIC, DCM_APPL_DATA) RxBufferSizePtr,
...
static FUNC(BufReq_ReturnType,DCM_CODE) Dcm_Lok_ProcessNoRequest( VAR(PduIdType, AUTOMATIC) DcmRxPduId,
        P2CONST(PduInfoType, AUTOMATIC, DCM_APPL_DATA) infoPtr,VAR(PduLengthType, AUTOMATIC) TpSduLength,
...
static FUNC(BufReq_ReturnType,DCM_CODE) Dcm_Lok_ProcessRequest_CheckPriority( VAR(PduIdType, AUTOMATIC) DcmRxPduId,
        P2CONST(PduInfoType, AUTOMATIC, DCM_APPL_DATA) infoPtr,VAR(PduLengthType, AUTOMATIC) TpSduLength,
        P2VAR(PduLengthType, AUTOMATIC, DCM_APPL_DATA) RxBufferSizePtr)
{
    VAR(BufReq_ReturnType, AUTOMATIC) bufRequestStatus_en = BUFREQ_E_NOT_OK;
...
static FUNC(BufReq_ReturnType,DCM_CODE) Dcm_Lok_ProcessRequestWhileDslBusy( VAR(PduIdType, AUTOMATIC) DcmRxPduId,
        P2CONST(PduInfoType, AUTOMATIC, DCM_APPL_DATA) infoPtr,VAR(PduLengthType, AUTOMATIC) TpSduLength,
        P2VAR(PduLengthType, AUTOMATIC, DCM_APPL_DATA) RxBufferSizePtr)
{
    VAR(BufReq_ReturnType, AUTOMATIC) bufRequestStatus_en = BUFREQ_E_NOT_OK;
...
static FUNC(BufReq_ReturnType,DCM_CODE) Dcm_Lok_ProcessRequestWhileDslFree( VAR(PduIdType, AUTOMATIC) DcmRxPduId,
        P2CONST(PduInfoType, AUTOMATIC, DCM_APPL_DATA) infoPtr,VAR(PduLengthType, AUTOMATIC) TpSduLength,
        P2VAR(PduLengthType, AUTOMATIC, DCM_APPL_DATA) RxBufferSizePtr)
{
...
static FUNC(uint8,DCM_CODE)Dcm_Lok_ValidateRequestType( VAR(PduIdType, AUTOMATIC) DcmRxPduId,
        P2CONST(PduInfoType, AUTOMATIC, DCM_APPL_DATA) infoPtr,VAR(PduLengthType, AUTOMATIC) TpSduLength)
{
    VAR(uint8,AUTOMATIC) connectionId_u8 = Dcm_DsldRxTable_pcu8[DcmRxPduId];
...
static FUNC(boolean,DCM_CODE) Dcm_Lok_ProcessSharedRxPduid(P2VAR(PduIdType, AUTOMATIC, DCM_APPL_DATA) RxPduIdPtr,
        P2CONST(PduInfoType, AUTOMATIC, DCM_APPL_DATA) infoPtr)
{
...
static FUNC(Std_ReturnType,DCM_CODE) Dcm_Lok_CheckPermissions(P2VAR(PduIdType, AUTOMATIC,DCM_APPL_DATA) RxPduIdPtr,
                P2CONST(PduInfoType, AUTOMATIC, DCM_APPL_DATA) infoPtr,VAR(PduLengthType, AUTOMATIC) TpSduLength)
{
...
static FUNC(boolean,DCM_CODE) Dcm_Lok_StartOfReception_CheckEnvironment(VAR(PduIdType, AUTOMATIC) DcmRxPduId,
        P2CONST(PduInfoType, AUTOMATIC, DCM_APPL_DATA) infoPtr,
