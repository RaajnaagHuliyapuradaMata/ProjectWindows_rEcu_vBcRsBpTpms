...
LOCAL_INLINE FUNC(boolean,DCM_CODE) Dcm_Lok_isConfirmationOnActiveConnection(VAR(PduIdType,AUTOMATIC) DcmTxPduId)
{
...
LOCAL_INLINE FUNC(boolean,DCM_CODE) Dcm_Lok_isConfirmationForRoeType2Response(VAR(PduIdType,AUTOMATIC) DcmTxPduId)
{
...
LOCAL_INLINE FUNC(boolean,DCM_CODE) Dcm_Lok_isConfirmationReceivedForNrc21Response(VAR(PduIdType,AUTOMATIC) DcmTxPduId,
...
static FUNC(void,DCM_CODE) Dcm_Lok_InformApplicationAfterQueueComplete (VAR(Dcm_DsldQueHandling_ten,AUTOMATIC) QueueHandlingTemp_en)
...
FUNC(void,DCM_CODE) Dcm_Lok_SendResponse(P2CONST(PduInfoType,AUTOMATIC,DCM_INTERN_DATA) adrPduStrucutre_pcst)
{
...
static FUNC(void,DCM_CODE)Dcm_Lok_ProcessTxConfirmation(VAR(PduIdType,AUTOMATIC) TxPduId,
