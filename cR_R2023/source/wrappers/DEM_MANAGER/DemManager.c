...
static void DemMGR__EspWspeedFrontRearBodyDirectionLCANMonitor(void)
{
  ...
  //{
  //
  //  Dem_GetEventStatus(DemMGR__CS_SignalMonitoringData[DEMMGR_E_ESP_WSPEED_FRONT_BODY_LCAN_INDEX1].U16_EventId, &U8_UdsStatus_DirectionDtc);
  //  Dem_GetEventStatus(DemMGR__CS_SignalMonitoringData[DEMMGR_E_ESP_WSPEED_FRONT_BODY_LCAN_INDEX1].U16_EventId, &U8_UdsStatus_SpeedDtc);
  //
  //  if (U8_UdsStatus_DirectionDtc & DEM_UDS_STATUS_TF == DEM_UDS_STATUS_TF)
  //  {
  //
  //    if ((U8_UdsStatus_SpeedDtc & DEM_UDS_STATUS_TF == DEM_UDS_STATUS_TF) && (U8_UdsStatus_SpeedDtc & DEM_UDS_STATUS_CDTC != DEM_UDS_STATUS_CDTC))
  //    {
  //
  //    }
  //    else
  ...
  //
  //if((DemMGR__CheckSignalTimeout(DEMMGR_E_ESP_WSPEED_FRONT_BODY_LCAN_INDEX1) != FALSE) || (DemMGR__CheckSignalTimeout(DEMMGR_E_ESP_WSPEED_REAR_BODY_LCAN_INDEX1) != FALSE))
  //{
  //
  //  Env_SetWheelInfo(ENV_E_REAR_LEFT_WHEEL_INDEX, CANMGR__WSPEED_SPEED_INVALID, (Env_Enum_VehicleDirection) ENV_E_VEHICLE_DIRECTION_UNKNOWN);
  //  Env_SetWheelInfo(ENV_E_REAR_RIGHT_WHEEL_INDEX, CANMGR__WSPEED_SPEED_INVALID, (Env_Enum_VehicleDirection) ENV_E_VEHICLE_DIRECTION_UNKNOWN);
...
static void DemMGR__EspWspeedFrontRearBodySpeedLCANMonitor(void)
{
  ...
  //
  //if((DemMGR__CheckSignalTimeout(DEMMGR_E_ESP_WSPEED_FRONT_BODY_LCAN_INDEX2) != FALSE) || (DemMGR__CheckSignalTimeout(DEMMGR_E_ESP_WSPEED_REAR_BODY_LCAN_INDEX2) != FALSE))
  //{
  //
  //  Env_SetWheelInfo(ENV_E_REAR_LEFT_WHEEL_INDEX, CANMGR__WSPEED_SPEED_INVALID, (Env_Enum_VehicleDirection) ENV_E_VEHICLE_DIRECTION_UNKNOWN);
  //  Env_SetWheelInfo(ENV_E_REAR_RIGHT_WHEEL_INDEX, CANMGR__WSPEED_SPEED_INVALID, (Env_Enum_VehicleDirection) ENV_E_VEHICLE_DIRECTION_UNKNOWN);
