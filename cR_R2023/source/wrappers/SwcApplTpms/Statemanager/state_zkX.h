...
////////////////////////////////////////////////////////////////////////////////////////////
// Bit mask for interface functions                                                                          *
////////////////////////////////////////////////////////////////////////////////////////////
// ZUSTANDSKENNUNG
#define cCAL_TIO              ((uint16) 0x0004)   // Abweisung der Kalibrierung wegen Timeout
#define cCAL_P_HA_INVALID     ((uint16) 0x0008)   // Kalibrierdruck Hinterachse ungultig
#define cCAL_P_VA_INVALID     ((uint16) 0x0010)   // Kalibrierdruck Vorderachse ungultig
#define cCAL_P_MIN_INVALID    ((uint16) 0x0020)   // Kalibrierdruck ungultig (Mindestsolldruck unterschritten)
