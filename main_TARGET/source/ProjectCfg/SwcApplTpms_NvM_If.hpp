...
extern uint8   GETucResetWarnPressRefEE(uint8 u8Index);
extern void    PUTucResetWarnPressRefEE(uint8 u8Index, uint8 lptru8Data);
extern void    PUTucPatmoEE(uint8 lptru8Data);
extern uint8   GETucPatmoEE (void);
extern void    PUTscAdaptedTrefEE(sint8 scData);
extern sint8   GETscAdaptedTrefEE(void);
extern void    PUTucReErrorStatusEE(uint8 lptru8Data);
extern uint8   GETucReErrorStatusEE(void);
extern void    PUTucReHeatUpStatusEE(uint8 lptru8Data);
...
extern void    PUTbHfIntLatchEE(uint8 lptru8Data);
extern boolean GETbHfIntLatchEE(void);
extern void    NvM2_PutEOLRoutineStatusEE(uint8 lptru8Data);
extern uint8   NvM2_GetEOLRoutineStatusEE(void);
extern void    NvM2_PutEOLRoutineActiveEE(uint8 lptru8Data);
extern uint8   NvM2_GetEOLRoutineActiveEE(void);
extern void    NvM2_PutDiagUsedToDeleteDTCEE(uint8 lptru8Data);
...
extern void NvM3_PUTHistoryWPInEE(uint8 *lptru8Data);
extern void NvM3_GETHistoryWPFromEE(uint8 *lptru8Data);
...
extern void    PUTucVarCodLegislationEE(uint8 lptru8Data);
extern uint8   GETucVarCodLegislationEE(void);
extern void NvM3_PUTucVarCodHighPressResetThresEE(uint8 lptru8Data);
...
extern void NvM3_PUTucVarCodOffroadPlacardPress(uint8 lptru8Data);
extern uint8 NvM3_GETucVarCodOffroadPlacardPress(void);
extern void    PUTucVarCodPlacardPressEE(uint8 lptru8Data);
extern uint8   GETucVarCodPlacardPressEE (void);
extern void    PUTucVarCodMinPressThresEE(uint8 lptru8Data);
extern uint8   GETucVarCodMinPressThresEE(void);
extern void    PUTucVarCodHighPressThresEE(uint8 lptru8Data);
extern uint8   GETucVarCodHighPressThresEE(void);
extern void    PUTucVarCodAxImbSetThresEE(uint8 lptru8Data);
extern uint8   GETucVarCodAxImbSetThresEE(void);
extern void    PUTucVarCodAxImbResThresEE(uint8 lptru8Data);
extern uint8   GETucVarCodAxImbResThresEE(void);
extern void NvM_WriteData_PressureFL(uint8 lptru8Data);
extern void NvM_ReadData_PressureFL(uint8 *ucpData);
extern void NvM_WriteData_PressureFR(uint8 lptru8Data);
extern void NvM_ReadData_PressureFR(uint8 *ucpData);
extern void NvM_WriteData_PressureRL(uint8 lptru8Data);
extern void NvM_ReadData_PressureRL(uint8 *ucpData);
extern void NvM_WriteData_PressureRR(uint8 lptru8Data);
extern void NvM_ReadData_PressureRR(uint8 *ucpData);
extern void NvM_WriteData_TemperatureFL(uint8 lptru8Data);
extern void NvM_ReadData_TemperatureFL(uint8 *ucpData);
extern void NvM_WriteData_TemperatureFR(uint8 lptru8Data);
extern void NvM_ReadData_TemperatureFR(uint8 *ucpData);
extern void NvM_WriteData_TemperatureRL(uint8 lptru8Data);
extern void NvM_ReadData_TemperatureRL(uint8 *ucpData);
extern void NvM_WriteData_TemperatureRR(uint8 lptru8Data);
extern void NvM_ReadData_TemperatureRR(uint8 *ucpData);
extern void    NvM_WriteData_ECUDefect(uint8 lptru8Data);
