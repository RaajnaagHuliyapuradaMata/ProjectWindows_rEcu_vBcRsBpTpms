...
FUNC(boolean,COM_CODE) Com_IPdu_Callout_VehSts_BodyLCAN(
          VAR(Type_SwcServiceCom_tIdPdu,    AUTOMATIC                ) id
   ,  P2CONST(Type_SwcServiceCom_stInfoPdu, AUTOMATIC, COM_APPL_CONST) ptr
){
   ...
   CANMGR_VehSts_BodyLCAN_UpdateValues(
      &AU8_Buffer[0]
   );
   return TRUE;
}
