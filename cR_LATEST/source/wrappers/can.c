...
void Can_ForwardMessageToCanIf(const Can_FrameType *tCanFrame){
   ...
   if(tCanIfControllerMode == CANIF_CS_STARTED){
      ...
      case CanMsgApplicationRequest_TPM:        tCanMailbox.Hoh = CanIfConf_CanIfHrhCfg_Can_Network_CANNODE_0_Rx_Std_MailBox_1_Config;      break;
      case CanMsgBCM_peripheralMasterclock:        tCanMailbox.Hoh = CanIfConf_CanIfHrhCfg_Can_Network_CANNODE_0_Rx_Std_MailBox_2_Config;      break;
      case CanMsgESP_WSpeed_Front_BodyLCAN:        tCanMailbox.Hoh = CanIfConf_CanIfHrhCfg_Can_Network_CANNODE_0_Rx_Std_MailBox_3_Config;      break;
      case CanMsgUDS_Rx_Functional:        tCanMailbox.Hoh = CanIfConf_CanIfHrhCfg_Can_Network_CANNODE_0_Rx_Std_MailBox_5_Config;      break;
      case CanMsgUDS_Rx_Physical:        tCanMailbox.Hoh = CanIfConf_CanIfHrhCfg_Can_Network_CANNODE_0_Rx_Std_MailBox_4_Config;      break;
      case CanMsgESP_WSpeed_Rear_BodyLCAN:        tCanMailbox.Hoh = CanIfConf_CanIfHrhCfg_Can_Network_CANNODE_0_Rx_Std_MailBox_6_Config;      break;
      case CanMsgESP_Wheel_Pulse_Stamped:        tCanMailbox.Hoh = CanIfConf_CanIfHrhCfg_Can_Network_CANNODE_0_Rx_Std_MailBox_7_Config;      break;
      case CanMsgTMM_Status_BodyLCAN:        tCanMailbox.Hoh = CanIfConf_CanIfHrhCfg_Can_Network_CANNODE_0_Rx_Std_MailBox_8_Config;      break;
      case CanMsgRdcData_TPM:        tCanMailbox.Hoh = CanIfConf_CanIfHrhCfg_Can_Network_CANNODE_0_Rx_Std_MailBox_9_Config;      break;
      case CanMsgVehSts_BodyLCAN:        tCanMailbox.Hoh = CanIfConf_CanIfHrhCfg_Can_Network_CANNODE_0_Rx_Std_MailBox_10_Config;      break;
      case CanMsgVmsStsReq_BodyLCAN:        tCanMailbox.Hoh = CanIfConf_CanIfHrhCfg_Can_Network_CANNODE_0_Rx_Std_MailBox_11_Config;      break;
         default:                                                                                                                    break;
      }
