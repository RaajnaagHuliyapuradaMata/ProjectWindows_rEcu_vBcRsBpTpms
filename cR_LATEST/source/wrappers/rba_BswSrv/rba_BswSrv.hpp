...
extern void* LibAutosar_vptrMemCopy(void* xDest_pv, const void* xSrc_pcv, uint32 numBytes_u32);
...
LOCAL_INLINE void   LibAutosar_vptrMemCopy64(rba_BswSrv_uint64* xDest_pu64, const rba_BswSrv_uint64* xSrc_pcu64, uint32 numBytes_u32);
LOCAL_INLINE void   LibAutosar_vptrMemCopy32(uint32* xDest_pu32, const uint32* xSrc_pcu32, uint32 numBytes_u32);
LOCAL_INLINE void   LibAutosar_vptrMemCopy16(uint16* xDest_pu16, const uint16* xSrc_pcu16, uint32 numBytes_u32);
LOCAL_INLINE void   LibAutosar_vptrMemCopy8(uint8* xDest_pu8, const uint8* xSrc_pcu8, uint32 numBytes_u32);
