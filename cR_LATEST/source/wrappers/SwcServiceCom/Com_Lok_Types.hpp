...
typedef struct{
   ...
   P2VAR(Type_SwcServiceCom_tLengthPdu, TYPEDEF, COM_APPL_DATA)                          Com_TpTxIpduLength_pauo;
#endif
   ...
   P2VAR(Type_SwcServiceCom_tIdPdu, TYPEDEF, COM_APPL_DATA)                              Com_RxGwQueue_paux;
