...
echo ##########################################################
cd .\03_application
copy %TARGET%.hex ..\..\..\..\..\repo_tools\Canoe\Vector_Download_Sequence\CANoe\_TestFiles\%TARGET%.hex
copy %TARGET%.sig ..\..\..\..\..\repo_tools\Canoe\Vector_Download_Sequence\CANoe\_TestFiles\%TARGET%.sig
