...
LOCAL_INLINE FUNC(void, COM_CODE) Com_Lok_Init_IpduWoGroupRef(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) IpduId);
#endif

LOCAL_INLINE FUNC(void, COM_CODE) Com_Lok_Init_TxSignal(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) IpduId);

#ifdef COM_TX_SIGNALGROUP
LOCAL_INLINE FUNC(void, COM_CODE) Com_Lok_Init_TxSignalGroup(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) IpduId);
