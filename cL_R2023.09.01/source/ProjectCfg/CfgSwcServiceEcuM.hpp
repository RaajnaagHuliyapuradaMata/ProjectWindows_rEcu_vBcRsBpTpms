...
/* PARAMS                                                                     */
/******************************************************************************/
extern const Type_CfgSwcServiceEcuM_st* const CfgSwcServiceEcuM_capst[CfgSwcServiceEcuM_dNumConfigSet];
extern CONST(uint8, SWCSERVICEECUM_CONST) CfgSwcServiceEcuM_au8HashPreCompile[CfgSwcServiceEcuM_dLenHash];

/******************************************************************************/
/* OBJECTS                                                                    */
/******************************************************************************/
extern VAR(Type_SwcServiceEcuM_stInfoTargetShutdown, SWCSERVICEECUM_VAR) SwcServiceEcuM_stInfoTargetShutdown; //TBD: Move to right header
