...
void Dem_SetCurrentMileage(uint32 ulMileage){  ulCurMileage = ulMileage;}

Std_ReturnType Dcm_DemGetSRData_SR_EDR_Record_ExtendedDataRecord0x01_DTCExtendedDataRecordData(uint8* ucExtendedRecordData){*ucExtendedRecordData = 0xff; return E_OK;}
...
Std_ReturnType DemEvent_ModuleNotProvisioned_InitMonForEvent(Dem_InitMonitorReasonType InitMonitorReason){return E_OK;}
