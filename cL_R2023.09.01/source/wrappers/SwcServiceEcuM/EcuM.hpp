...
extern Std_ReturnType EcuM_GetShutdownCause(Type_SwcServiceEcuM_tCauseShutdown* shutdownCause);
...
Std_ReturnType EcuM_Rn_GetLastShutdownInfo(EcuM_ShutdownInfoType* shutdownCauseInfo);
#endif //ECUM_CFG_NVM_BLOCK_CONFIGURED
