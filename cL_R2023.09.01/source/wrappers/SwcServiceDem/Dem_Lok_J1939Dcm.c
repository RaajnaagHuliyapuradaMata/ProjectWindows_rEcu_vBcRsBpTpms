...
Std_ReturnType Dem_J1939DcmClearDTC(Dem_J1939DcmSetClearFilterType DTCTypeFilter, uint8 node)
{
   uint8 ClientId = DEM_CLIENTID_J1939;

    return Dem_J1939DcmClearDTC_4_3 (DTCTypeFilter, node, ClientId);
}
