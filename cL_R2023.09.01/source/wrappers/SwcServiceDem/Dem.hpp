...
#include "rba_DemBfm.hpp"
#endif

#if(DEM_CFG_OBD != DEM_CFG_OBD_OFF)
#include "rba_DemObd.hpp"
#endif
...
#if((!defined DEM_HIDE_RTE_APIS) || ((DEM_CFG_SUPPRESSION == DEM_NO_SUPPRESSION) || (DEM_CFG_SUPPRESSION == DEM_EVENT_SUPPRESSION)))
