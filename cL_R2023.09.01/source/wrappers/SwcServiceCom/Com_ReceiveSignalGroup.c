...
uint8 Com_ReceiveSignalGroup(Com_SignalGroupIdType SignalGroupId)
{
...
#endif
   {
        ...
        for(idx_RxGrpSig_u16 = RxSigGrpConstPtr->No_Of_GrpSig; idx_RxGrpSig_u16 != COM_ZERO; idx_RxGrpSig_u16--)
        {
            ...
            case 0x03u:
            {
                COM_GET_RXGRPSIGTYPEUINT8_BUFF(rxMainFuncId,rxGrpSignalBuffIndex) =
...
#endif
                COM_GET_RXGRPSIGTYPEUINT16_BUFF(rxMainFuncId,rxGrpSignalBuffIndex) =
                        COM_GET_SECRXGRPSIGTYPEU16_BUFF(rxMainFuncId,rxGrpSignalBuffIndex);
#if(CPU_TYPE == CPU_TYPE_8)
...

            {
                ...
                SchM_Enter_Com_RxGrpSigBuff();
#endif
                COM_GET_RXGRPSIGTYPEUINT32_BUFF(rxMainFuncId,rxGrpSignalBuffIndex) =
                        COM_GET_SECRXGRPSIGTYPEU32_BUFF(rxMainFuncId,rxGrpSignalBuffIndex);
#if(CPU_TYPE != CPU_TYPE_32)
                SchM_Exit_Com_RxGrpSigBuff();
#endif
            }
            ...
            {
                SchM_Enter_Com_RxGrpSigBuff();
                COM_GET_RXGRPSIGTYPEUINT64_BUFF(rxMainFuncId,rxGrpSignalBuffIndex) =
                        COM_GET_SECRXGRPSIGTYPEU64_BUFF(rxMainFuncId,rxGrpSignalBuffIndex);
                SchM_Exit_Com_RxGrpSigBuff();
            }
                break;
#endif
            ...
            case (COM_FLOAT64 >> 1u):
            {
                ...
                SchM_Enter_Com_RxGrpSigBuff();
                COM_GET_RXGRPSIGTYPEFLOAT64_BUFF(rxMainFuncId,rxGrpSignalBuffIndex) =
