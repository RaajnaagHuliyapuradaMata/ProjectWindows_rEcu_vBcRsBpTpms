...
void Dcm_RcSetSignalArray(const Type_SwcServiceDcm_stInfoSignalRoutine * adrSignal_pcst,const uint8 * adrReqBuffer_u8)
{
     uint8 xDataType_u8;
     uint16 DataLen_u16;
     uint16 IndexSig_u16;
...
void Dcm_RcStoreSignalArray(const Type_SwcServiceDcm_stInfoSignalRoutine * adrSignal_pcst,uint8 * adrResBuffer_u8)
{
