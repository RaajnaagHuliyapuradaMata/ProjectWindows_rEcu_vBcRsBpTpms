...
static Std_ReturnType Dcm_GetDynamicSignalConfiguration(uint16 DidIndex_u16)
{
   ...
   for(index_u16=0;index_u16<CfgSwcServiceDcm_astListDid[DidIndex_u16].nrSig_u16;index_u16++)
   {

#if(DCM_CFG_DSP_ALLSIGNAL_FIXED_LENGTH != DCM_CFG_ON)
FixedLength_b=Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstSignalDid[index_u16].idxDcmDspDatainfo_u16].dataFixedLength_b;
#endif

        if(FixedLength_b   !=FALSE)
        {

            if(Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstSignalDid[index_u16].idxDcmDspDatainfo_u16].dataType_u8!=DCM_BOOLEAN)
            {

                Dcm_DynamicSignalConfig_cast[index_u16].sigPosnBit_u32=CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstSignalDid[index_u16].posnSigBit_u16;
                Dcm_DynamicSignalConfig_cast[index_u16].sigDataSize_u32=Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstSignalDid[index_u16].idxDcmDspDatainfo_u16].dataSize_u16;
            }
        ...
        if(FixedLength_b==FALSE)
        {
            ...
            if(((Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstSignalDid[index_u16].idxDcmDspDatainfo_u16].usePort_u8 == USE_DATA_SYNCH_FNC) || \
                    (Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstSignalDid[index_u16].idxDcmDspDatainfo_u16].usePort_u8 == USE_DATA_ASYNCH_FNC) ||    \
                    (Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstSignalDid[index_u16].idxDcmDspDatainfo_u16].usePort_u8 == USE_DATA_SYNCH_CLIENT_SERVER) ||   \
                    (Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstSignalDid[index_u16].idxDcmDspDatainfo_u16].usePort_u8 == USE_DATA_ASYNCH_CLIENT_SERVER)) &&     \
                    ((CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstDidExtended->dataAllowedSessRead_u32 >0x00u) && (CfgSwcServiceDcm_castListInfoDidWrite[Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstSignalDid[index_u16].idxDcmDspDatainfo_u16].idxDcmDspControlInfo_u16].adrReadDataLengthFnc_pfct != NULL_PTR)))

            {

                if(FALSE==CfgSwcServiceDcm_astListDid[DidIndex_u16].dataDynamicDid_b)
                {

                    if((Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstSignalDid[index_u16].idxDcmDspDatainfo_u16].usePort_u8 == USE_DATA_SYNCH_FNC) || (Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstSignalDid[index_u16].idxDcmDspDatainfo_u16].usePort_u8 == USE_DATA_SYNCH_CLIENT_SERVER))
                    {
                        dataRetVal_u8 = (*(ReadDataLengthFnc1_pf)(CfgSwcServiceDcm_castListInfoDidWrite[Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstSignalDid[index_u16].idxDcmDspDatainfo_u16].idxDcmDspControlInfo_u16].adrReadDataLengthFnc_pfct))(&dataSigLength_u16);
                    }
                    else
                    {
                        if((Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstSignalDid[index_u16].idxDcmDspDatainfo_u16].usePort_u8 == USE_DATA_ASYNCH_CLIENT_SERVER) || (Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstSignalDid[index_u16].idxDcmDspDatainfo_u16].usePort_u8 == USE_DATA_ASYNCH_FNC)
#if(DCM_CFG_RDBIPAGEDBUFFERSUPPORT != DCM_CFG_OFF)
                                ||  (Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstSignalDid[index_u16].idxDcmDspDatainfo_u16].usePort_u8 == USE_DATA_RDBI_PAGED_FNC)
#endif
                        )
                        {

                            dataRetVal_u8 = (*(ReadDataLengthFnc4_pf)(CfgSwcServiceDcm_castListInfoDidWrite[Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstSignalDid[index_u16].idxDcmDspDatainfo_u16].idxDcmDspControlInfo_u16].adrReadDataLengthFnc_pfct))(s_Dcm_idxSrcDidIndexType_st.dataopstatus_b,&dataSigLength_u16);
                        }
                   }
                   Dcm_DynamicSignalConfig_cast[index_u16].sigDataSize_u32 = dataSigLength_u16;
                    ...
                    dataRetVal_u8 = (*(ReadDataLengthFnc2_pf)(CfgSwcServiceDcm_castListInfoDidWrite[Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstSignalDid[index_u16].idxDcmDspDatainfo_u16].idxDcmDspControlInfo_u16].adrReadDataLengthFnc_pfct))(&dataSigLength_u32);
                ...
                if(dataRetVal_u8==E_OK)
                {
                    ...
                    if(((Dcm_DynamicSignalConfig_cast[index_u16].sigDataSize_u32 > Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstSignalDid[index_u16].idxDcmDspDatainfo_u16].dataSize_u16) ||(Dcm_DynamicSignalConfig_cast[index_u16].sigDataSize_u32==0u)) &&(CfgSwcServiceDcm_astListDid[DidIndex_u16].dataDynamicDid_b == FALSE))
                    {
                        dataRetVal_u8 = E_NOT_OK;
                        break;
                    }
                }
                else if((dataRetVal_u8==DCM_E_PENDING) && ((Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstSignalDid[index_u16].idxDcmDspDatainfo_u16].usePort_u8 == USE_DATA_ASYNCH_CLIENT_SERVER) || (Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstSignalDid[index_u16].idxDcmDspDatainfo_u16].usePort_u8 == USE_DATA_ASYNCH_FNC)
#if(DCM_CFG_RDBIPAGEDBUFFERSUPPORT != DCM_CFG_OFF)
                        ||  (Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[DidIndex_u16].pcstSignalDid[index_u16].idxDcmDspDatainfo_u16].usePort_u8 == USE_DATA_RDBI_PAGED_FNC)
#endif
                ))
...
static Std_ReturnType Dcm_isDDDIDSupported(uint16 DynamicIdentifier_u16)
{
   ...
   {
        if(CfgSwcServiceDcm_astListDid[index_u16].dataDid_u16==DynamicIdentifier_u16)
        {
            break;
        }
   }
   if(index_u16==Dcm_DIDcalculateTableSize_u16())
   {
        ...
        if(*Dcm_DIDIsAvail[CfgSwcServiceDcm_astListDid[index_u16].idxDIDSupportedFnc_u16]!=NULL_PTR)
        {
            if((*(IsDIDAvailFnc_pf)(Dcm_DIDIsAvail[CfgSwcServiceDcm_astListDid[index_u16].idxDIDSupportedFnc_u16]))(DynamicIdentifier_u16)!=E_OK)
            {
                retVal_u8 = E_NOT_OK;
            }
        }
...
void Dcm_DDDI_Ini (void){
   ...
   {
        if(((Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[s_Dcm_idxSrcDidIndexType_st.idxIndex_u16].pcstSignalDid[Dcm_DidSignalIdx_u16].idxDcmDspDatainfo_u16].idxDcmDspControlInfo_u16 >0u) && (CfgSwcServiceDcm_astListDid[s_Dcm_idxSrcDidIndexType_st.idxIndex_u16].pcstDidExtended->dataAllowedSessRead_u32 >0x00u))&&
                ((CfgSwcServiceDcm_castListInfoDidWrite[Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[s_Dcm_idxSrcDidIndexType_st.idxIndex_u16].pcstSignalDid[Dcm_DidSignalIdx_u16].idxDcmDspDatainfo_u16].idxDcmDspControlInfo_u16].adrCondChkRdFnc_cpv)!= NULL_PTR)&&
                ((Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[s_Dcm_idxSrcDidIndexType_st.idxIndex_u16].pcstSignalDid[Dcm_DidSignalIdx_u16].idxDcmDspDatainfo_u16].usePort_u8 == USE_DATA_ASYNCH_CLIENT_SERVER) ||
                        (Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[s_Dcm_idxSrcDidIndexType_st.idxIndex_u16].pcstSignalDid[Dcm_DidSignalIdx_u16].idxDcmDspDatainfo_u16].usePort_u8 == USE_DATA_ASYNCH_FNC)))
        {

            dataCondChkRetVal_u8 = (*(CondChkReadFunc2_pfct)(CfgSwcServiceDcm_castListInfoDidWrite[Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[s_Dcm_idxSrcDidIndexType_st.idxIndex_u16].pcstSignalDid[Dcm_DidSignalIdx_u16].idxDcmDspDatainfo_u16].idxDcmDspControlInfo_u16].adrCondChkRdFnc_cpv))(DCM_CANCEL, &NegResCode_u8);
        }
   }
#if(DCM_CFG_DSP_DDDISTORINGTONVRAM_ENABLED != DCM_CFG_OFF)
            ...
            else if(dataSubFunction_u8==DCM_DEFINITION_BY_ID)
            {
                ...
                if((dataReqMsgLen_u32>0u) && ((dataReqMsgLen_u32 % 4u)==0u))
                {
                    ...
                    if(dataFuncRetVal_u8==E_OK)
                    {
                        ...
                        if((dataFuncRetVal_u8 == E_OK) && (idxsrcDidIndexType_st.dataRange_b == FALSE) && (*Dcm_DIDIsAvail[CfgSwcServiceDcm_astListDid[idxsrcDidIndexType_st.idxIndex_u16].idxDIDSupportedFnc_u16] != NULL_PTR))
                        {
                            if((*(IsDIDAvailFnc_pf)(Dcm_DIDIsAvail[CfgSwcServiceDcm_astListDid[idxsrcDidIndexType_st.idxIndex_u16].idxDIDSupportedFnc_u16]))(dataDid_u16)!=E_OK)
                            {
                        ...
                        if(dataFuncRetVal_u8==E_OK)
                        {
                            ...
                            if(((Dcm_DsldGetActiveSessionMask_u32() & \
                                    (CfgSwcServiceDcm_astListDid[idxsrcDidIndexType_st.idxIndex_u16].pcstDidExtended->dataAllowedSessRead_u32))!= 0x00uL))
                            {

                                if((Dcm_DsldGetActiveSecurityMask_u32()& \
                                        (CfgSwcServiceDcm_astListDid[idxsrcDidIndexType_st.idxIndex_u16].pcstDidExtended->dataAllowedSecRead_u32))!=0x00uL)
                                {
                                    Dcm_DddiIdContext_tst * stContext_st;
                    ...
                    else
                    {
                        ...
                        if((dataReqMsgLen_u16%dataBlockLen_u8)==0)
                        {
                            ...
                            if(dataFuncRetVal_u8==E_OK)
                            {
                                ...
                                if((dataFuncRetVal_u8 == E_OK) && (idxDidIndexType_st.dataRange_b ==FALSE)&& (*Dcm_DIDIsAvail[CfgSwcServiceDcm_astListDid[idxDidIndexType_st.idxIndex_u16].idxDIDSupportedFnc_u16] != NULL_PTR))
                                {
                                    if((*(IsDIDAvailFnc_pf)(Dcm_DIDIsAvail[CfgSwcServiceDcm_astListDid[idxDidIndexType_st.idxIndex_u16].idxDIDSupportedFnc_u16]))(dataDid_u16)!=E_OK)
                                    {
                                        dataFuncRetVal_u8 = E_NOT_OK;
                                    }
                                }
                                ...
                                if(dataFuncRetVal_u8==E_OK)
                                {
                                    ...
                                    if(((Dcm_DsldGetActiveSessionMask_u32() & \
                                            (CfgSwcServiceDcm_astListDid[idxDidIndexType_st.idxIndex_u16].pcstDidExtended->dataAllowedSessRead_u32))!= 0x00uL))
                                    {

                                        if((Dcm_DsldGetActiveSecurityMask_u32()& \
                                                (CfgSwcServiceDcm_astListDid[idxDidIndexType_st.idxIndex_u16].pcstDidExtended->dataAllowedSecRead_u32))!=0x00uL)
                                        {
                                            Dcm_DddiIdContext_tst * stContext_st;
        ...
        while((Dcm_AddIdCurrentBlockIndex_u16<nrBlocks_u16) && (dataRetVal_u8==E_OK))
        {
                ...
                if(dataDid_u16 == Dcm_DDDIBaseConfig_cast[idxIndex_u16].dataDddId_u16)
                {
                    *dataNegRespCode_u8         = DCM_E_REQUESTOUTOFRANGE;
                    ...
                    if(E_OK == dataFuncRetVal_u8 )
                    {
                        ...
                        if((s_Dcm_idxSrcDidIndexType_st.dataRange_b ==FALSE)&& (*Dcm_DIDIsAvail[CfgSwcServiceDcm_astListDid[s_Dcm_idxSrcDidIndexType_st.idxIndex_u16].idxDIDSupportedFnc_u16] != NULL_PTR))
                        {
                            if((*(IsDIDAvailFnc_pf)(Dcm_DIDIsAvail[CfgSwcServiceDcm_astListDid[s_Dcm_idxSrcDidIndexType_st.idxIndex_u16].idxDIDSupportedFnc_u16]))(dataDid_u16)!=E_OK)
                            {
                                dataFuncRetVal_u8 = E_NOT_OK;
                            }
                        }
                        ...
                        if(E_OK == dataFuncRetVal_u8 )
                        {
                            for(idxLoop_u16=0;idxLoop_u16<CfgSwcServiceDcm_astListDid[s_Dcm_idxSrcDidIndexType_st.idxIndex_u16].nrSig_u16;idxLoop_u16++)
                            {
                                if(Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[s_Dcm_idxSrcDidIndexType_st.idxIndex_u16].pcstSignalDid[idxLoop_u16].idxDcmDspDatainfo_u16].usePort_u8 == USE_DATA_RDBI_PAGED_FNC)
                                {
                                    dataFuncRetVal_u8=E_NOT_OK;
                                    *dataNegRespCode_u8 = DCM_E_REQUESTOUTOFRANGE;
                                    break;
                    ...
                    if(dataFuncRetVal_u8==E_OK)
                    {
                        ...
                        if((dataFuncRetVal_u8 ==E_OK) &&  (((adrSourceBuffer_pcu8[(Dcm_AddIdCurrentBlockIndex_u16*DCM_DDDI_DEFINE_BY_ID_BLOCKLENGTH)+3u])+ Dcm_AddIdCurrentLength_u32) <=  CfgSwcServiceDcm_astListDid[idxsrcDidIndexType_st.idxIndex_u16].dataMaxDidLen_u16))
                        {
            ...
            if(Dcm_stAddIdRecords_en == DCM_DDDI_DEFINE_BY_ID_GETLENGTH)
            {
                ...
                if(s_dataFunctionRetVal_u8==E_OK)
                {
                    ...
                    if(((s_dataLength_u32 <=  CfgSwcServiceDcm_astListDid[s_Dcm_idxSrcDidIndexType_st.idxIndex_u16].dataMaxDidLen_u16) && (FALSE== s_Dcm_idxSrcDidIndexType_st.dataRange_b)) ||((s_dataLength_u32 <=  Dcm_DIDRangeConfig_cast[s_Dcm_idxSrcDidIndexType_st.idxIndex_u16].dataMaxDidLen_u16)&& (FALSE != s_Dcm_idxSrcDidIndexType_st.dataRange_b )))
#else
                        if( s_dataLength_u32 <=  CfgSwcServiceDcm_astListDid[s_Dcm_idxSrcDidIndexType_st.idxIndex_u16].dataMaxDidLen_u16 )
#endif
                        {
                                ...
                                if((s_dataLength_u32+1u) >= (posnInSourceDataRecord_u8+dataMemorySize_u8))
                                {
                                    ...
                                    if(FALSE== s_Dcm_idxSrcDidIndexType_st.dataRange_b)
                                    {
                                        ...
                                        if(s_dataLengthFuncRetVal_u8 == E_OK)
                                        {
                                            ...
                                            for(idxSignal1_u16=0; (idxSignal1_u16 < CfgSwcServiceDcm_astListDid[s_Dcm_idxSrcDidIndexType_st.idxIndex_u16].nrSig_u16)&&(flgErrorIndn_b==FALSE);idxSignal1_u16++)
                                            {
                                                if((Dcm_DynamicSignalConfig_cast[idxSignal1_u16].sigPosnBit_u32) ==((uint32)(posnInSourceDataRecord_u8-(uint8)1u)))
                                                {
                                                    for(idxSignal2_u16=idxSignal1_u16;(idxSignal2_u16<CfgSwcServiceDcm_astListDid[s_Dcm_idxSrcDidIndexType_st.idxIndex_u16].nrSig_u16)&&(flgErrorIndn_b==FALSE);
                                                            idxSignal2_u16++)
                                                    {
   ...
   if(dataRetValGetLen_u8 == E_OK)
   {
        ...
        while((Dcm_AddMemCurrentBlockIndex_u16<nrBlocks_u16) &&(dataRetVal_u8==E_OK))
        {
            if(Dcm_stAddMemRecords_en == DCM_DDDI_DEFINE_BY_MEM_GETSUPPORT)
            {
                ...
                dataFuncRetVal_u8 = Dcm_Lok_GetIndexOfDID (Dcm_DDDIBaseConfig_cast[idxIndex_u16].dataDddId_u16,&idxsrcDidIndexType_st);
                flgValidMemoryAccess_b = Dcm_DddiCheckOverflow(dataMemRecord_st.dataMemLength_u32,Dcm_AddIdCurrentLength_u32,CfgSwcServiceDcm_astListDid[idxsrcDidIndexType_st.idxIndex_u16].dataMaxDidLen_u16);
