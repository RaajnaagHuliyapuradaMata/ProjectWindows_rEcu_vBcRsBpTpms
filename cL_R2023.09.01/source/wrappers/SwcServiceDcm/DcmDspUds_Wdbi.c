...
static void Dcm_Lok_WDBIINIT_Pending(void)
   ...
   const Type_CfgSwcServiceDcm_stInfoDidWrite * ptrControlSigConfig;
    ...
    ptrDidConfig = &CfgSwcServiceDcm_astListDid[s_Dcm_idxwdbiDidIndexType.idxIndex_u16];
        ...
        switch(ptrSigConfig->dataType_u8)
        {
           ...
           case DCM_UINT8:
                dataSignal_u32 = Dcm_GetSignal_u32(ptrSigConfig->dataType_u8,\
                                (ptrDidConfig->pcstSignalDid[Dcm_DidSignalIdx_u16].posnSigBit_u16 +(uint16)(idxLoop_u16*8)),\
...
DataEndiannessType_u8
           ...
           case DCM_UINT16:
                dataSignal_u32 = Dcm_GetSignal_u32(ptrSigConfig->dataType_u8,\
                              (ptrDidConfig->pcstSignalDid[Dcm_DidSignalIdx_u16].posnSigBit_u16 +(uint16)(idxLoop_u16*16)),\
                              &pMsgContext->reqData[0x02],
DataEndiannessType_u8
           ...
           case DCM_UINT32:
                dataSignal_u32 = Dcm_GetSignal_u32(ptrSigConfig->dataType_u8,\
                              (ptrDidConfig->pcstSignalDid[Dcm_DidSignalIdx_u16].posnSigBit_u16+(uint16)(idxLoop_u16*32)),\
                              &pMsgContext->reqData[0x02],
DataEndiannessType_u8
...
static void Dcm_Lok_WriteDidUsePort
   ...
   const Type_CfgSwcServiceDcm_stInfoDidWrite* ptrControlSigConfig = &CfgSwcServiceDcm_castListInfoDidWrite[ptrSigConfig->idxDcmDspControlInfo_u16];
        ...
        if((TRUE == ptrDidConfig->AtomicorNewSRCommunication_b) && \
           ...
           (ptrDidConfig->pcstSignalDid[Dcm_DidSignalIdx_u16].fptrSenderReceiverWrite != NULL_PTR) && (ptrControlSigConfig->GetSignalData_pfct != NULL_PTR))
        {

            (void)(ptrControlSigConfig->GetSignalData_pfct)(&pMsgContext->reqData[2], ptrDidConfig->pcstSignalDid[Dcm_DidSignalIdx_u16].posnSigBit_u16);
            dataRetWriteFunc_u8 = (Std_ReturnType)(ptrDidConfig->pcstSignalDid[Dcm_DidSignalIdx_u16].fptrSenderReceiverWrite)(ptrControlSigConfig->VarDataWrite);
...
NvM_RequestResultType dataRequestResult_u8;
 ...
 static void Dcm_Lok_WriteAtomicDID
   ...
   const Type_CfgSwcServiceDcm_stDid * ptrDidConfig = &CfgSwcServiceDcm_astListDid[s_Dcm_idxwdbiDidIndexType.idxIndex_u16];
...
static void Dcm_Lok_WriteNormalDID
  ...
  boolean Rtn_InfrastureError;
        ...
        posnDidSignal_u16 = (uint16)((ptrDidConfig->pcstSignalDid[Dcm_DidSignalIdx_u16].posnSigBit_u16) +2u);
...
uint16 nrLenDataRec_u16;
      ...
      if(s_Dcm_idxwdbiDidIndexType.dataRange_b == FALSE)
#endif
        {
           ...
           nrLenDataRec_u16 = (CfgSwcServiceDcm_astListDid[s_Dcm_idxwdbiDidIndexType.idxIndex_u16].dataMaxDidLen_u16+2u);

           if(CfgSwcServiceDcm_astListDid[s_Dcm_idxwdbiDidIndexType.idxIndex_u16].dataFixedLength_b != FALSE)
           {
...
#endif
#if(DCM_CFG_DIDSUPPORT != DCM_CFG_OFF)
        pcstDidExtended = CfgSwcServiceDcm_astListDid[s_Dcm_idxwdbiDidIndexType.idxIndex_u16].pcstDidExtended;

#endif
#if( DCM_CFG_DIDRANGE_EXTENSION != DCM_CFG_OFF)
     }
     else{
        pcstDidExtended = Dcm_DIDRangeConfig_cast[s_Dcm_idxwdbiDidIndexType.idxIndex_u16].pcstDidExtended;
     }
#endif
...
const Type_CfgSwcServiceDcm_stDid * ptrDidConfig = &CfgSwcServiceDcm_astListDid[s_Dcm_idxwdbiDidIndexType.idxIndex_u16];
...
#endif
   {
        ...
        nrDidSignal_u16 = CfgSwcServiceDcm_astListDid[s_Dcm_idxwdbiDidIndexType.idxIndex_u16].nrSig_u16;

        alloweWritedSession_u32 = CfgSwcServiceDcm_astListDid[s_Dcm_idxwdbiDidIndexType.idxIndex_u16].\
                                    pcstDidExtended->dataAllowedSessWrite_u32;

        for(idxDidSignal_u16=0x0; idxDidSignal_u16 < nrDidSignal_u16; idxDidSignal_u16++)
        {

            useDidPort_u8 = Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[s_Dcm_idxwdbiDidIndexType.idxIndex_u16].\
                            pcstSignalDid[idxDidSignal_u16].idxDcmDspDatainfo_u16].usePort_u8;

            ptrWriteFnc = CfgSwcServiceDcm_castListInfoDidWrite[Dcm_DspDataInfo_st[CfgSwcServiceDcm_astListDid[s_Dcm_idxwdbiDidIndexType.idxIndex_u16].\
                          pcstSignalDid[idxDidSignal_u16].idxDcmDspDatainfo_u16].idxDcmDspControlInfo_u16].adrWriteFnc_cpv;
...
#if(DCM_CFG_DSP_WRITE_NEW_SR_INTERFACE_ENABLED != DCM_CFG_OFF)
                || ((ptrDidConfig->AtomicorNewSRCommunication_b == TRUE) &&  ((useDidPort_u8 == USE_DATA_SENDER_RECEIVER) || (useDidPort_u8 == USE_DATA_SENDER_RECEIVER_AS_SERVICE)) && (ptrDidConfig->pcstSignalDid[Dcm_DidSignalIdx_u16].fptrSenderReceiverWrite == NULL_PTR) && (ptrDidConfig->didUsePort_u8 == USE_DATA_ELEMENT_SPECIFIC_INTERFACES))
#endif
            )
            {
                break;
                                    ...
                                    (Dcm_NegativeResponseCodeType * dataNegRespCode_u8)
{
   ...
   if((dataRetGetDID_u8 == E_OK)&& (s_Dcm_idxwdbiDidIndexType.dataRange_b==FALSE))
   {
        ...
        if(*Dcm_DIDIsAvail[CfgSwcServiceDcm_astListDid[s_Dcm_idxwdbiDidIndexType.idxIndex_u16].idxDIDSupportedFnc_u16] != NULL_PTR)
        {
            if((*(IsDIDAvailFnc_pf)(Dcm_DIDIsAvail[CfgSwcServiceDcm_astListDid[s_Dcm_idxwdbiDidIndexType.idxIndex_u16].\
...
{
#if(DCM_CFG_ATOMICWRITE_DID>0)
   const Type_CfgSwcServiceDcm_stDid * ptrDidConfig = NULL_PTR;
#endif
...
Std_ReturnType SwcServiceDcm_tWriteDataByIdentifier
...
Std_ReturnType Dcm_GetActiveWDBIDid(uint16 * dataDid_u16)
{
   ...
   if(s_Dcm_idxwdbiDidIndexType.dataRange_b==FALSE)
   {
        ...
        *dataDid_u16 = CfgSwcServiceDcm_astListDid[s_Dcm_idxwdbiDidIndexType.idxIndex_u16].dataDid_u16;
