...
#include "Com_MemMap.hpp"
 FUNC(boolean, COM_CODE) COM_CheckRxIPduCalibrationVarStatus(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) IpduId);
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
 FUNC(boolean, COM_CODE) COM_CheckTxIPduCalibrationVarStatus(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) IpduId);
#define COM_STOP_SEC_CODE
#include "Com_MemMap.hpp"
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
FUNC(uint16, COM_CODE)  COM_getTxIPduCyclePeriod(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) IpduId);
#define COM_STOP_SEC_CODE
#include "Com_MemMap.hpp"
#endif
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
FUNC(uint16, COM_CODE)  Com_GetRxIPduTimeoutCalibration(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) IpduId);
#define COM_STOP_SEC_CODE
#include "Com_MemMap.hpp"
#endif
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
FUNC(uint16, COM_CODE)  Com_GetTxIPduTimeOffsetCalibration(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) IpduId);
#define COM_STOP_SEC_CODE
#include "Com_MemMap.hpp"
#endif
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
FUNC(uint8, COM_CODE)  Com_GetTxIPduNumberOfRepetitionCalibration(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) IpduId);
#define COM_STOP_SEC_CODE
#include "Com_MemMap.hpp"
#endif
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
 FUNC(boolean, COM_CODE)  Com_CheckTxIPduControlViaRbaNdsEcuVariant(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) IpduId);
#define COM_STOP_SEC_CODE
#include "Com_MemMap.hpp"
#endif
...
#define COM_START_SEC_CODE
#include "Com_MemMap.hpp"
 FUNC(boolean, COM_CODE)  Com_CheckRxIPduControlViaRbaNdsEcuVariant(VAR(Type_SwcServiceCom_tIdPdu, AUTOMATIC) IpduId);
#define COM_STOP_SEC_CODE
#include "Com_MemMap.hpp"
...
#include "Com_MemMap.hpp"
extern VAR(Type_SwcServiceCom_tLengthPdu,COM_VAR)           Com_TpTxIpduLength_auo[];
