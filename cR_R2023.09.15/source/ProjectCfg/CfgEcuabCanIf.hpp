...
typedef struct{
   ...
   P2FUNC(void, CANIF_APPL_CODE, UserTxConfirmation)(Type_SwcServiceCom_tIdPdu);
...
typedef struct{
   P2FUNC(void, TYPEDEF, CanIfRxPduIndicationName) (VAR(Type_SwcServiceCom_tIdPdu,AUTOMATIC), P2CONST(Type_SwcServiceCom_stInfoPdu, TYPEDEF, CANIF_APPL_DATA));
